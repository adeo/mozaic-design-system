...
!(function (t) {
  ...
  var i = {
    deepValue: function (t, e) {
      for (var n = 0, e = e.split('.'), i = e.length; i > n; n++) {
        if (!t) return null
        t = t[e[n]]
      }
      return t
  ...
  ;(e.defaultOptions = {
    ...
    (e.prototype.search = function (t) {
      var e,
        ...
        s,
        r,
        a = new this.options.searchFn(t, this.options),
        h = this.list,
        p = h.length,
        c = this.options,
        l = this.options.keys,
      ...
      if ('string' == typeof h[0]) for (var e = 0; p > e; e++) m(h[e], e, e)
      else
        for (var e = 0; p > e; e++)
          for (o = h[e], n = 0; u > n; n++) m(this.options.getFn(o, l[n]), o, e)
      c.shouldSort && f.sort(c.sortFn)
      for (
        var y = c.includeScore
            ? function (t) {
                return f[t]
              }
            : function (t) {
