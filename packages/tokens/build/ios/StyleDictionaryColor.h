...
ColorButtonSolidSecondaryBackground,
ColorButtonSolidSecondaryFont,
ColorButtonSolidSecondaryFocusBorder,
ColorButtonSolidSecondaryDisabledBackground,
ColorButtonSolidSecondaryDisabledFont,
ColorButtonSolidSecondaryActiveBackground,
ColorButtonSolidSecondaryHoverBackground,
ColorButtonSolidSecondaryHoverFont,
...
ColorButtonBorderedSecondaryBackground,
ColorButtonBorderedSecondaryBorder,
ColorButtonBorderedSecondaryFont,
ColorButtonBorderedSecondaryFocusBorder,
ColorButtonBorderedSecondaryDisabledBackground,
ColorButtonBorderedSecondaryDisabledFont,
ColorButtonBorderedSecondaryActiveBackground,
ColorButtonBorderedSecondaryHoverBackground,
...
ColorLinkPrimaryFont,
ColorLinkPrimaryFocusFont,
ColorLinkPrimaryDisabledFont,
ColorLinkPrimaryActiveFont,
ColorLinkPrimaryHoverFont,
ColorLinkDarkFont,
ColorLinkDarkFocusFont,
ColorLinkDarkDisabledFont,
ColorLinkDarkActiveFont,
ColorLinkDarkHoverFont,
ColorLinkLightFont,
ColorLinkLightFocusFont,
ColorLinkLightDisabledFont,
ColorLinkLightActiveFont,
ColorLinkLightHoverFont,
ColorLinkNeutralFont,
ColorLinkNeutralFocusFont,
ColorLinkNeutralDisabledFont,
ColorLinkNeutralActiveFont,
ColorLinkNeutralHoverFont,
ColorLinkPrimaryCampusFont,
ColorLinkPrimaryCampusFocusFont,
ColorLinkPrimaryCampusDisabledFont,
ColorLinkPrimaryCampusActiveFont,
ColorLinkPrimaryCampusHoverFont,
ColorLinkDangerFont,
ColorLinkDangerFocusFont,
ColorLinkDangerDisabledFont,
ColorLinkDangerActiveFont,
ColorLinkDangerHoverFont
};
