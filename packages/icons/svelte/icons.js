...
if (!customElements.get('navigation-arrow-arrow--bottom-16px')) {
  customElements.define(
    'navigation-arrow-arrow--bottom-16px',
    ArrowArrowBottom16
  )
}
...
if (!customElements.get('navigation-arrow-arrowbottomleft-16px')) {
  customElements.define(
    'navigation-arrow-arrowbottomleft-16px',
    ArrowArrowBottomLeft16
  )
}
...
if (!customElements.get('navigation-arrow-arrowtopleft-16px')) {
  customElements.define(
    'navigation-arrow-arrowtopleft-16px',
    ArrowArrowTopLeft16
  )
}
...
if (!customElements.get('navigation-arrow-doublearrow--left-16px')) {
  customElements.define(
    'navigation-arrow-doublearrow--left-16px',
    ArrowDoubleArrowLeft16
  )
}
if (!customElements.get('navigation-arrow-doublearrow--right-16px')) {
  customElements.define(
    'navigation-arrow-doublearrow--right-16px',
    ArrowDoubleArrowRight16
  )
}
if (!customElements.get('navigation-arrow-down-16px')) {
  customElements.define('navigation-arrow-down-16px', ArrowDown16)
}
if (!customElements.get('navigation-arrow-next-16px')) {
  customElements.define('navigation-arrow-next-16px', ArrowNext16)
}
if (!customElements.get('navigation-arrow-up-16px')) {
  customElements.define('navigation-arrow-up-16px', ArrowUp16)
}
...
if (!customElements.get('navigation-display-externallink-16px')) {
  customElements.define(
    'navigation-display-externallink-16px',
...
if (!customElements.get('navigation-publish-favoritefull-16px')) {
  customElements.define(
    'navigation-publish-favoritefull-16px',
    PublishFavoriteFull16
  )
}
...
if (!customElements.get('device-tablet-24px')) {
  customElements.define('device-tablet-24px', Tablet24)
}
...
if (!customElements.get('instruction-hygiene-nocontact-24px')) {
  customElements.define(
    'instruction-hygiene-nocontact-24px',
    HygieneNoContact24
  )
}
if (!customElements.get('instruction-hygiene-plexiglas-24px')) {
  customElements.define(
    'instruction-hygiene-plexiglas-24px',
    HygienePlexiglas24
  )
}
if (!customElements.get('instruction-payment-checkout-24px')) {
  customElements.define('instruction-payment-checkout-24px', PaymentCheckout24)
}
if (!customElements.get('instruction-payment-nocontact-24px')) {
  customElements.define(
    'instruction-payment-nocontact-24px',
    PaymentNoContact24
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--openboot-24px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--openboot-24px',
    ServicePurchaseHelpCarOpenBoot24
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--standinline-24px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--standinline-24px',
    ServicePurchaseHelpCarStandInLine24
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--stayinside-24px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--stayinside-24px',
    ServicePurchaseHelpCarStayInside24
  )
}
if (!customElements.get('instruction-service-purchasehelp-loading-24px')) {
  customElements.define(
    'instruction-service-purchasehelp-loading-24px',
    ServicePurchaseHelpLoading24
  )
}
if (!customElements.get('instruction-service-purchasehelp-nocarrent-24px')) {
  customElements.define(
    'instruction-service-purchasehelp-nocarrent-24px',
    ServicePurchaseHelpNoCarRent24
  )
}
if (!customElements.get('instruction-service-purchasehelp-request-24px')) {
  customElements.define(
    'instruction-service-purchasehelp-request-24px',
    ServicePurchaseHelpRequest24
  )
}
if (!customElements.get('instruction-service-purchasehelp-truck-24px')) {
  customElements.define(
    'instruction-service-purchasehelp-truck-24px',
    ServicePurchaseHelpTruck24
  )
}
if (!customElements.get('instruction-universe-essentialproduct-24px')) {
  customElements.define(
    'instruction-universe-essentialproduct-24px',
    UniverseEssentialProduct24
  )
}
if (!customElements.get('logotypes-payment-monochrome-bizum-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-bizum-24px',
    PaymentMonochromeBizum24
  )
}
if (!customElements.get('logotypes-payment-monochrome-bonificobancario-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-bonificobancario-24px',
    PaymentMonochromeBonificoBancario24
  )
}
if (!customElements.get('logotypes-payment-monochrome-fintecture-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-fintecture-24px',
    PaymentMonochromeFintecture24
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--way-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--way-24px',
    PaymentMonochromeMBWay24
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--multibanco-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--multibanco-24px',
    PaymentMonochromeMBMultibanco24
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney-24px',
    PaymentMonochromeOney24
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--3x-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x-24px',
    PaymentMonochromeOney3x24
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--3x4x-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x4x-24px',
    PaymentMonochromeOney3x4x24
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--4x-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--4x-24px',
    PaymentMonochromeOney4x24
  )
}
if (!customElements.get('logotypes-payment-monochrome-paypal-24px')) {
  customElements.define(
    'logotypes-payment-monochrome-paypal-24px',
    PaymentMonochromePayPal24
  )
}
...
if (!customElements.get('media-picker-24px')) {
  customElements.define('media-picker-24px', Picker24)
}
...
if (!customElements.get('media-sound-24px')) {
  customElements.define('media-sound-24px', Sound24)
}
...
if (!customElements.get('navigation-arrow-arrow--bottom-24px')) {
  customElements.define(
    'navigation-arrow-arrow--bottom-24px',
    ArrowArrowBottom24
  )
}
...
if (!customElements.get('navigation-arrow-arrowbottomleft-24px')) {
  customElements.define(
    'navigation-arrow-arrowbottomleft-24px',
    ArrowArrowBottomLeft24
  )
}
if (!customElements.get('navigation-arrow-arrowbottomright-24px')) {
  customElements.define(
    'navigation-arrow-arrowbottomright-24px',
    ArrowArrowBottomRight24
  )
}
if (!customElements.get('navigation-arrow-arrowtopleft-24px')) {
  customElements.define(
    'navigation-arrow-arrowtopleft-24px',
    ArrowArrowTopLeft24
  )
}
if (!customElements.get('navigation-arrow-arrowtopright-24px')) {
  customElements.define(
    'navigation-arrow-arrowtopright-24px',
    ArrowArrowTopRight24
  )
}
...
if (!customElements.get('navigation-arrow-doublearrow--left-24px')) {
  customElements.define(
    'navigation-arrow-doublearrow--left-24px',
    ArrowDoubleArrowLeft24
  )
}
if (!customElements.get('navigation-arrow-doublearrow--right-24px')) {
  customElements.define(
    'navigation-arrow-doublearrow--right-24px',
    ArrowDoubleArrowRight24
  )
}
...
if (!customElements.get('navigation-display-displayfull-filled-24px')) {
  customElements.define(
    'navigation-display-displayfull-filled-24px',
    DisplayDisplayFullFilled24
  )
}
if (!customElements.get('navigation-display-displayfull-outline-24px')) {
  customElements.define(
    'navigation-display-displayfull-outline-24px',
    DisplayDisplayFullOutline24
  )
}
if (!customElements.get('navigation-display-displaylist-filled-24px')) {
  customElements.define(
    'navigation-display-displaylist-filled-24px',
    DisplayDisplayListFilled24
  )
}
if (!customElements.get('navigation-display-displaymobile--horizontal-24px')) {
  customElements.define(
    'navigation-display-displaymobile--horizontal-24px',
    DisplayDisplayMobileHorizontal24
  )
}
if (!customElements.get('navigation-display-displaymobile--vertical-24px')) {
  customElements.define(
    'navigation-display-displaymobile--vertical-24px',
    DisplayDisplayMobileVertical24
  )
}
if (!customElements.get('navigation-display-displayproductx4-filled-24px')) {
  customElements.define(
    'navigation-display-displayproductx4-filled-24px',
    DisplayDisplayProductX4Filled24
  )
}
if (!customElements.get('navigation-display-displayproductx4-outline-24px')) {
  customElements.define(
    'navigation-display-displayproductx4-outline-24px',
    DisplayDisplayProductX4Outline24
  )
}
if (!customElements.get('navigation-display-displayproductx9-24px')) {
  customElements.define(
    'navigation-display-displayproductx9-24px',
    DisplayDisplayProductX924
  )
}
if (!customElements.get('navigation-display-externallink-24px')) {
  customElements.define(
    'navigation-display-externallink-24px',
    DisplayExternalLink24
  )
}
...
if (!customElements.get('navigation-display-displaylist-outline-24px')) {
  customElements.define(
    'navigation-display-displaylist-outline-24px',
    DisplayDisplayListOutline24
  )
}
if (!customElements.get('navigation-display-refresh-24px')) {
  customElements.define('navigation-display-refresh-24px', DisplayRefresh24)
}
if (!customElements.get('navigation-display-screenrotation-24px')) {
  customElements.define(
    'navigation-display-screenrotation-24px',
    DisplayScreenRotation24
  )
}
...
if (!customElements.get('navigation-display-searchlist-24px')) {
  customElements.define(
    'navigation-display-searchlist-24px',
    DisplaySearchList24
  )
}
if (!customElements.get('navigation-display-searchproduct-24px')) {
  customElements.define(
    'navigation-display-searchproduct-24px',
    DisplaySearchProduct24
  )
}
...
if (!customElements.get('navigation-display-productnumb-24px')) {
  customElements.define(
    'navigation-display-productnumb-24px',
    DisplayProductNumb24
  )
}
...
if (!customElements.get('navigation-publish-favoritefull-24px')) {
  customElements.define(
    'navigation-publish-favoritefull-24px',
    PublishFavoriteFull24
  )
}
...
if (!customElements.get('payment-cards-monochrome-americanexpress-24px')) {
  customElements.define(
    'payment-cards-monochrome-americanexpress-24px',
    CardsMonochromeAmericanExpress24
  )
}
if (!customElements.get('payment-bill-24px')) {
  customElements.define('payment-bill-24px', Bill24)
...
if (!customElements.get('payment-cards-monochrome-cheque-24px')) {
  customElements.define(
    'payment-cards-monochrome-cheque-24px',
    CardsMonochromeCheque24
  )
}
if (!customElements.get('payment-cards-monochrome-gift-24px')) {
  customElements.define(
    'payment-cards-monochrome-gift-24px',
    CardsMonochromeGift24
  )
}
if (!customElements.get('payment-cards-monochrome-illicado-24px')) {
  customElements.define(
    'payment-cards-monochrome-illicado-24px',
    CardsMonochromeIllicado24
  )
}
if (!customElements.get('payment-cards-monochrome-loyalty-24px')) {
  customElements.define(
    'payment-cards-monochrome-loyalty-24px',
    CardsMonochromeLoyalty24
  )
}
...
if (!customElements.get('payment-cards-monochrome-mastercard-24px')) {
  customElements.define(
    'payment-cards-monochrome-mastercard-24px',
    CardsMonochromeMastercard24
  )
}
if (!customElements.get('payment-cards-monochrome-oney-24px')) {
  customElements.define(
    'payment-cards-monochrome-oney-24px',
    CardsMonochromeOney24
  )
}
if (!customElements.get('payment-cards-monochrome-oneyx3-24px')) {
  customElements.define(
    'payment-cards-monochrome-oneyx3-24px',
    CardsMonochromeOneyX324
  )
}
if (!customElements.get('payment-cards-monochrome-paylib-24px')) {
  customElements.define(
    'payment-cards-monochrome-paylib-24px',
    CardsMonochromePaylib24
  )
}
if (!customElements.get('payment-cards-monochrome-paypal-24px')) {
  customElements.define(
    'payment-cards-monochrome-paypal-24px',
    CardsMonochromePaypal24
  )
}
if (!customElements.get('payment-cards-monochrome-visa-24px')) {
  customElements.define(
    'payment-cards-monochrome-visa-24px',
    CardsMonochromeVisa24
  )
}
...
if (!customElements.get('product-basket-add-24px')) {
  customElements.define('product-basket-add-24px', BasketAdd24)
}
...
if (!customElements.get('product-basket-standard-24px')) {
  customElements.define('product-basket-standard-24px', BasketStandard24)
}
if (!customElements.get('product-list-add-24px')) {
  customElements.define('product-list-add-24px', ListAdd24)
}
...
if (!customElements.get('product-promise-certification-24px')) {
  customElements.define(
    'product-promise-certification-24px',
    PromiseCertification24
  )
}
if (!customElements.get('product-promise-circulareconomy-24px')) {
  customElements.define(
    'product-promise-circulareconomy-24px',
    PromiseCircularEconomy24
  )
}
...
if (!customElements.get('payment-cards-monochrome-maestro-24px')) {
  customElements.define(
    'payment-cards-monochrome-maestro-24px',
    CardsMonochromeMaestro24
  )
}
if (!customElements.get('product-promise-fashionchoice-24px')) {
  customElements.define(
    'product-promise-fashionchoice-24px',
    PromiseFashionChoice24
  )
}
if (!customElements.get('product-promise-madeineurope-24px')) {
  customElements.define(
    'product-promise-madeineurope-24px',
    PromiseMadeInEurope24
  )
}
if (!customElements.get('product-promise-madeinfrance-24px')) {
  customElements.define(
    'product-promise-madeinfrance-24px',
    PromiseMadeInFrance24
  )
}
if (!customElements.get('product-promise-modular-24px')) {
  customElements.define('product-promise-modular-24px', PromiseModular24)
}
if (!customElements.get('product-promise-productonpicture-24px')) {
  customElements.define(
    'product-promise-productonpicture-24px',
    PromiseProductOnPicture24
  )
}
if (!customElements.get('product-promise-productsheet-24px')) {
  customElements.define(
    'product-promise-productsheet-24px',
    PromiseProductSheet24
  )
}
...
if (!customElements.get('payment-cards-monochrome-oneyx4-24px')) {
  customElements.define(
    'payment-cards-monochrome-oneyx4-24px',
    CardsMonochromeOneyX424
  )
}
...
if (!customElements.get('service-aftersales-helpline-24px')) {
  customElements.define(
    'service-aftersales-helpline-24px',
    AfterSalesHelpline24
  )
}
...
if (!customElements.get('service-aftersales-satisfaction-24px')) {
  customElements.define(
    'service-aftersales-satisfaction-24px',
    AfterSalesSatisfaction24
  )
}
if (!customElements.get('service-custom-copykey-24px')) {
  customElements.define('service-custom-copykey-24px', CustomCopyKey24)
}
if (!customElements.get('service-custom-course-24px')) {
  customElements.define('service-custom-course-24px', CustomCourse24)
}
if (!customElements.get('service-custom-cutwoodglass-24px')) {
  customElements.define(
    'service-custom-cutwoodglass-24px',
    CustomCutWoodGlass24
  )
}
if (!customElements.get('service-custom-sample-24px')) {
  customElements.define('service-custom-sample-24px', CustomSample24)
}
if (!customElements.get('service-delivery-delivery-pickup--relaypoint-24px')) {
  customElements.define(
    'service-delivery-delivery-pickup--relaypoint-24px',
    DeliveryDeliveryPickupRelayPoint24
  )
}
if (!customElements.get('service-custom-sharpening-24px')) {
  customElements.define('service-custom-sharpening-24px', CustomSharpening24)
}
if (!customElements.get('service-delivery-delivery-pickup--store-24px')) {
  customElements.define(
    'service-delivery-delivery-pickup--store-24px',
    DeliveryDeliveryPickupStore24
  )
}
if (!customElements.get('service-delivery-delivery--home-24px')) {
  customElements.define(
    'service-delivery-delivery--home-24px',
    DeliveryDeliveryHome24
  )
}
if (!customElements.get('service-delivery-delivery--locker-24px')) {
  customElements.define(
    'service-delivery-delivery--locker-24px',
    DeliveryDeliveryLocker24
  )
}
if (!customElements.get('service-pallet-24px')) {
  customElements.define('service-pallet-24px', Pallet24)
}
if (!customElements.get('service-purchasehelp-carrent-24px')) {
  customElements.define(
    'service-purchasehelp-carrent-24px',
    PurchaseHelpCarRent24
  )
}
if (!customElements.get('service-purchasehelp-homediy-24px')) {
  customElements.define(
    'service-purchasehelp-homediy-24px',
    PurchaseHelpHomeDIY24
  )
}
if (!customElements.get('service-purchasehelp-homeinstall-24px')) {
  customElements.define(
    'service-purchasehelp-homeinstall-24px',
    PurchaseHelpHomeInstall24
  )
}
if (!customElements.get('service-purchasehelp-toolrent-24px')) {
  customElements.define(
    'service-purchasehelp-toolrent-24px',
    PurchaseHelpToolRent24
  )
}
if (!customElements.get('service-time-delivery--2h-24px')) {
  customElements.define('service-time-delivery--2h-24px', TimeDelivery2h24)
}
if (!customElements.get('service-aftersales-aftersalesservice-24px')) {
  customElements.define(
    'service-aftersales-aftersalesservice-24px',
    AfterSalesAfterSalesService24
  )
}
...
if (!customElements.get('service-tools-3d-24px')) {
  customElements.define('service-tools-3d-24px', Tools3d24)
}
...
if (!customElements.get('social-comment-question--article-24px')) {
  customElements.define(
    'social-comment-question--article-24px',
    CommentQuestionArticle24
  )
}
...
if (!customElements.get('product-promise-ecoproduct-24px')) {
  customElements.define('product-promise-ecoproduct-24px', PromiseEcoProduct24)
}
...
if (!customElements.get('social-socialnetwork-facebook-24px')) {
  customElements.define(
    'social-socialnetwork-facebook-24px',
    SocialNetworkFacebook24
  )
}
if (!customElements.get('social-socialnetwork-instagram-24px')) {
  customElements.define(
    'social-socialnetwork-instagram-24px',
    SocialNetworkInstagram24
  )
}
if (!customElements.get('social-socialnetwork-linkedin-24px')) {
  customElements.define(
    'social-socialnetwork-linkedin-24px',
    SocialNetworkLinkedin24
  )
}
if (!customElements.get('social-socialnetwork-pinterest-24px')) {
  customElements.define(
    'social-socialnetwork-pinterest-24px',
    SocialNetworkPinterest24
  )
}
if (!customElements.get('social-socialnetwork-twitter-24px')) {
  customElements.define(
    'social-socialnetwork-twitter-24px',
    SocialNetworkTwitter24
  )
}
if (!customElements.get('social-socialnetwork-youtube-24px')) {
  customElements.define(
    'social-socialnetwork-youtube-24px',
    SocialNetworkYoutube24
  )
}
...
if (!customElements.get('store-monochrome-storelocation-bm-24px')) {
  customElements.define(
    'store-monochrome-storelocation-bm-24px',
    MonochromeStoreLocationbm24
  )
}
...
if (!customElements.get('universe-bedroom-24px')) {
  customElements.define('universe-bedroom-24px', Bedroom24)
}
if (!customElements.get('universe-christmastree-24px')) {
  customElements.define('universe-christmastree-24px', ChristmasTree24)
}
if (!customElements.get('universe-connectedhome-24px')) {
  customElements.define('universe-connectedhome-24px', ConnectedHome24)
}
...
if (!customElements.get('universe-hard-hat-alt-24px')) {
  customElements.define('universe-hard-hat-alt-24px', Hardhatalt24)
}
...
if (!customElements.get('universe-carpentry-24px')) {
  customElements.define('universe-carpentry-24px', Carpentry24)
}
...
if (!customElements.get('universe-masonry-alt-24px')) {
  customElements.define('universe-masonry-alt-24px', Masonryalt24)
}
...
if (!customElements.get('user-account-customer--collaborator-24px')) {
  customElements.define(
    'user-account-customer--collaborator-24px',
    AccountCustomerCollaborator24
  )
}
if (!customElements.get('user-account-customer--passion-24px')) {
  customElements.define(
    'user-account-customer--passion-24px',
    AccountCustomerPassion24
  )
}
...
if (!customElements.get('user-account-profile--woman-24px')) {
  customElements.define(
    'user-account-profile--woman-24px',
    AccountProfileWoman24
  )
}
...
if (!customElements.get('various-a11y-24px')) {
  customElements.define('various-a11y-24px', A11y24)
}
...
if (!customElements.get('various-partnercompany-24px')) {
  customElements.define('various-partnercompany-24px', PartnerCompany24)
}
if (!customElements.get('various-partnerworker-24px')) {
  customElements.define('various-partnerworker-24px', PartnerWorker24)
}
if (!customElements.get('various-pipe-24px')) {
  customElements.define('various-pipe-24px', Pipe24)
}
if (!customElements.get('various-premium-24px')) {
  customElements.define('various-premium-24px', Premium24)
}
if (!customElements.get('various-shutter-24px')) {
  customElements.define('various-shutter-24px', Shutter24)
}
...
if (!customElements.get('various-thermalcontrol-24px')) {
  customElements.define('various-thermalcontrol-24px', ThermalControl24)
}
...
if (!customElements.get('instruction-hygiene-danger-32px')) {
  customElements.define('instruction-hygiene-danger-32px', HygieneDanger32)
}
...
if (!customElements.get('instruction-hygiene-nocontact-32px')) {
  customElements.define(
    'instruction-hygiene-nocontact-32px',
    HygieneNoContact32
  )
}
if (!customElements.get('instruction-hygiene-plexiglas-32px')) {
  customElements.define(
    'instruction-hygiene-plexiglas-32px',
    HygienePlexiglas32
  )
}
if (!customElements.get('instruction-payment-checkout-32px')) {
  customElements.define('instruction-payment-checkout-32px', PaymentCheckout32)
}
if (!customElements.get('instruction-payment-nocontact-32px')) {
  customElements.define(
    'instruction-payment-nocontact-32px',
    PaymentNoContact32
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--openboot-32px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--openboot-32px',
    ServicePurchaseHelpCarOpenBoot32
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--standinline-32px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--standinline-32px',
    ServicePurchaseHelpCarStandInLine32
  )
}
...
if (!customElements.get('instruction-service-purchasehelp-loading-32px')) {
  customElements.define(
    'instruction-service-purchasehelp-loading-32px',
    ServicePurchaseHelpLoading32
  )
}
if (!customElements.get('instruction-service-purchasehelp-nocarrent-32px')) {
  customElements.define(
    'instruction-service-purchasehelp-nocarrent-32px',
    ServicePurchaseHelpNoCarRent32
  )
}
if (!customElements.get('instruction-service-purchasehelp-request-32px')) {
  customElements.define(
    'instruction-service-purchasehelp-request-32px',
    ServicePurchaseHelpRequest32
  )
}
if (!customElements.get('instruction-service-purchasehelp-truck-32px')) {
  customElements.define(
    'instruction-service-purchasehelp-truck-32px',
    ServicePurchaseHelpTruck32
  )
}
if (!customElements.get('instruction-universe-essentialproduct-32px')) {
  customElements.define(
    'instruction-universe-essentialproduct-32px',
    UniverseEssentialProduct32
  )
}
if (!customElements.get('logotypes-payment-monochrome-bizum-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-bizum-32px',
    PaymentMonochromeBizum32
  )
}
if (!customElements.get('logotypes-payment-monochrome-fintecture-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-fintecture-32px',
    PaymentMonochromeFintecture32
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--multibanco-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--multibanco-32px',
    PaymentMonochromeMBMultibanco32
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--way-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--way-32px',
    PaymentMonochromeMBWay32
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney-32px',
    PaymentMonochromeOney32
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--3x-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x-32px',
    PaymentMonochromeOney3x32
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--3x4x-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x4x-32px',
    PaymentMonochromeOney3x4x32
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--4x-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--4x-32px',
    PaymentMonochromeOney4x32
  )
}
if (!customElements.get('logotypes-payment-monochrome-paypal-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-paypal-32px',
    PaymentMonochromePayPal32
  )
}
if (!customElements.get('media-api-32px')) {
  customElements.define('media-api-32px', API32)
}
if (!customElements.get('media-bookstore-32px')) {
  customElements.define('media-bookstore-32px', BookStore32)
}
if (
  !customElements.get('instruction-service-purchasehelp-car--stayinside-32px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--stayinside-32px',
    ServicePurchaseHelpCarStayInside32
  )
}
...
if (!customElements.get('media-fullscreen-32px')) {
  customElements.define('media-fullscreen-32px', FullScreen32)
}
if (!customElements.get('media-gauge-32px')) {
  customElements.define('media-gauge-32px', Gauge32)
}
if (!customElements.get('media-group-32px')) {
  customElements.define('media-group-32px', Group32)
}
if (!customElements.get('various-toolbox-24px')) {
  customElements.define('various-toolbox-24px', ToolBox24)
}
if (!customElements.get('media-nopicture-32px')) {
  customElements.define('media-nopicture-32px', NoPicture32)
}
if (!customElements.get('media-image-alt-32px')) {
  customElements.define('media-image-alt-32px', Imagealt32)
}
...
if (!customElements.get('logotypes-payment-monochrome-bonificobancario-32px')) {
  customElements.define(
    'logotypes-payment-monochrome-bonificobancario-32px',
    PaymentMonochromeBonificoBancario32
  )
}
...
if (!customElements.get('media-server-32px')) {
  customElements.define('media-server-32px', Server32)
}
...
if (!customElements.get('navigation-arrow-arrow--bottom-32px')) {
  customElements.define(
    'navigation-arrow-arrow--bottom-32px',
    ArrowArrowBottom32
  )
}
...
if (!customElements.get('navigation-arrow-arrowbottomleft-32px')) {
  customElements.define(
    'navigation-arrow-arrowbottomleft-32px',
    ArrowArrowBottomLeft32
  )
}
if (!customElements.get('navigation-arrow-arrowbottomright-32px')) {
  customElements.define(
    'navigation-arrow-arrowbottomright-32px',
    ArrowArrowBottomRight32
  )
}
if (!customElements.get('navigation-arrow-arrowtopleft-32px')) {
  customElements.define(
    'navigation-arrow-arrowtopleft-32px',
    ArrowArrowTopLeft32
  )
}
...
if (!customElements.get('navigation-arrow-arrowtopright-32px')) {
  customElements.define(
    'navigation-arrow-arrowtopright-32px',
    ArrowArrowTopRight32
  )
}
if (!customElements.get('navigation-arrow-back-32px')) {
  customElements.define('navigation-arrow-back-32px', ArrowBack32)
}
if (!customElements.get('navigation-arrow-doublearrow--left-32px')) {
  customElements.define(
    'navigation-arrow-doublearrow--left-32px',
    ArrowDoubleArrowLeft32
  )
}
if (!customElements.get('navigation-arrow-doublearrow--right-32px')) {
  customElements.define(
    'navigation-arrow-doublearrow--right-32px',
    ArrowDoubleArrowRight32
  )
}
...
if (!customElements.get('navigation-arrow-up-32px')) {
  customElements.define('navigation-arrow-up-32px', ArrowUp32)
}
if (!customElements.get('navigation-control-circle--cross-32px')) {
  customElements.define(
    'navigation-control-circle--cross-32px',
    ControlCircleCross32
  )
}
if (!customElements.get('navigation-control-circle--less-32px')) {
  customElements.define(
    'navigation-control-circle--less-32px',
    ControlCircleLess32
  )
}
if (!customElements.get('navigation-control-circle--more-32px')) {
  customElements.define(
    'navigation-control-circle--more-32px',
    ControlCircleMore32
  )
}
...
if (!customElements.get('navigation-display-displayfull-filled-32px')) {
  customElements.define(
    'navigation-display-displayfull-filled-32px',
    DisplayDisplayFullFilled32
  )
}
...
if (!customElements.get('navigation-display-displayfull-outline-32px')) {
  customElements.define(
    'navigation-display-displayfull-outline-32px',
    DisplayDisplayFullOutline32
  )
}
if (!customElements.get('navigation-display-displaylist-filled-32px')) {
  customElements.define(
    'navigation-display-displaylist-filled-32px',
    DisplayDisplayListFilled32
  )
}
...
if (!customElements.get('navigation-display-displaylist-outline-32px')) {
  customElements.define(
    'navigation-display-displaylist-outline-32px',
    DisplayDisplayListOutline32
  )
}
if (!customElements.get('navigation-display-displaymobile--horizontal-32px')) {
  customElements.define(
    'navigation-display-displaymobile--horizontal-32px',
    DisplayDisplayMobileHorizontal32
  )
}
if (!customElements.get('navigation-display-displaymobile--vertical-32px')) {
  customElements.define(
    'navigation-display-displaymobile--vertical-32px',
    DisplayDisplayMobileVertical32
  )
}
if (!customElements.get('navigation-display-displayproductx4-filled-32px')) {
  customElements.define(
    'navigation-display-displayproductx4-filled-32px',
    DisplayDisplayProductX4Filled32
  )
}
if (!customElements.get('navigation-display-displayproductx4-outline-32px')) {
  customElements.define(
    'navigation-display-displayproductx4-outline-32px',
    DisplayDisplayProductX4Outline32
  )
}
if (!customElements.get('navigation-display-displayproductx9-32px')) {
  customElements.define(
    'navigation-display-displayproductx9-32px',
    DisplayDisplayProductX932
  )
}
if (!customElements.get('navigation-display-externallink-32px')) {
  customElements.define(
    'navigation-display-externallink-32px',
    DisplayExternalLink32
  )
}
...
if (!customElements.get('navigation-display-movingblock-32px')) {
  customElements.define(
    'navigation-display-movingblock-32px',
    DisplayMovingBlock32
  )
}
...
if (!customElements.get('navigation-display-productnumb-32px')) {
  customElements.define(
    'navigation-display-productnumb-32px',
    DisplayProductNumb32
  )
}
...
if (!customElements.get('navigation-display-screenrotation-32px')) {
  customElements.define(
    'navigation-display-screenrotation-32px',
    DisplayScreenRotation32
  )
}
...
if (!customElements.get('navigation-display-searchlist-32px')) {
  customElements.define(
    'navigation-display-searchlist-32px',
    DisplaySearchList32
  )
}
if (!customElements.get('navigation-display-searchproduct-32px')) {
  customElements.define(
    'navigation-display-searchproduct-32px',
    DisplaySearchProduct32
  )
}
...
if (!customElements.get('navigation-display-vocalsearch-32px')) {
  customElements.define(
    'navigation-display-vocalsearch-32px',
    DisplayVocalSearch32
  )
}
if (!customElements.get('navigation-notification-available-32px')) {
  customElements.define(
    'navigation-notification-available-32px',
    NotificationAvailable32
  )
}
...
if (!customElements.get('navigation-notification-circle--available-32px')) {
  customElements.define(
    'navigation-notification-circle--available-32px',
    NotificationCircleAvailable32
  )
}
if (!customElements.get('navigation-notification-information-32px')) {
  customElements.define(
    'navigation-notification-information-32px',
    NotificationInformation32
  )
}
if (!customElements.get('navigation-notification-question-32px')) {
  customElements.define(
    'navigation-notification-question-32px',
    NotificationQuestion32
  )
}
if (!customElements.get('navigation-notification-warning-32px')) {
  customElements.define(
    'navigation-notification-warning-32px',
    NotificationWarning32
  )
}
...
if (!customElements.get('navigation-publish-favoritefull-32px')) {
  customElements.define(
    'navigation-publish-favoritefull-32px',
    PublishFavoriteFull32
  )
}
...
if (!customElements.get('payment-cards-monochrome-americanexpress-32px')) {
  customElements.define(
    'payment-cards-monochrome-americanexpress-32px',
    CardsMonochromeAmericanExpress32
  )
}
...
if (!customElements.get('payment-cards-monochrome-cheque-32px')) {
  customElements.define(
    'payment-cards-monochrome-cheque-32px',
    CardsMonochromeCheque32
  )
}
if (!customElements.get('payment-cards-monochrome-gift-32px')) {
  customElements.define(
    'payment-cards-monochrome-gift-32px',
    CardsMonochromeGift32
  )
}
if (!customElements.get('payment-cards-monochrome-illicado-32px')) {
  customElements.define(
    'payment-cards-monochrome-illicado-32px',
    CardsMonochromeIllicado32
  )
}
if (!customElements.get('payment-cards-monochrome-loyalty-32px')) {
  customElements.define(
    'payment-cards-monochrome-loyalty-32px',
    CardsMonochromeLoyalty32
  )
}
if (!customElements.get('payment-cards-monochrome-maestro-32px')) {
  customElements.define(
    'payment-cards-monochrome-maestro-32px',
    CardsMonochromeMaestro32
  )
}
if (!customElements.get('payment-cards-monochrome-mastercard-32px')) {
  customElements.define(
    'payment-cards-monochrome-mastercard-32px',
    CardsMonochromeMastercard32
  )
}
if (!customElements.get('payment-cards-monochrome-oney-32px')) {
  customElements.define(
    'payment-cards-monochrome-oney-32px',
    CardsMonochromeOney32
  )
}
if (!customElements.get('payment-cards-monochrome-oneyx3-32px')) {
  customElements.define(
    'payment-cards-monochrome-oneyx3-32px',
    CardsMonochromeOneyX332
  )
}
if (!customElements.get('payment-cards-monochrome-oneyx4-32px')) {
  customElements.define(
    'payment-cards-monochrome-oneyx4-32px',
    CardsMonochromeOneyX432
  )
}
...
if (!customElements.get('payment-cards-monochrome-paypal-32px')) {
  customElements.define(
    'payment-cards-monochrome-paypal-32px',
    CardsMonochromePaypal32
  )
}
if (!customElements.get('payment-cards-monochrome-visa-32px')) {
  customElements.define(
    'payment-cards-monochrome-visa-32px',
    CardsMonochromeVisa32
  )
}
...
if (!customElements.get('payment-cards-monochrome-paylib-32px')) {
  customElements.define(
    'payment-cards-monochrome-paylib-32px',
    CardsMonochromePaylib32
  )
}
...
if (!customElements.get('product-aspect-weight-32px')) {
  customElements.define('product-aspect-weight-32px', AspectWeight32)
}
...
if (!customElements.get('product-list-add-32px')) {
  customElements.define('product-list-add-32px', ListAdd32)
}
if (!customElements.get('product-list-standard-32px')) {
  customElements.define('product-list-standard-32px', ListStandard32)
}
if (!customElements.get('product-promise-certification-32px')) {
  customElements.define(
    'product-promise-certification-32px',
    PromiseCertification32
  )
}
if (!customElements.get('product-promise-circulareconomy-32px')) {
  customElements.define(
    'product-promise-circulareconomy-32px',
    PromiseCircularEconomy32
  )
}
if (!customElements.get('product-promise-destocking-32px')) {
  customElements.define('product-promise-destocking-32px', PromiseDestocking32)
}
...
if (!customElements.get('product-promise-fashionchoice-32px')) {
  customElements.define(
    'product-promise-fashionchoice-32px',
    PromiseFashionChoice32
  )
}
...
if (!customElements.get('product-promise-madeineurope-32px')) {
  customElements.define(
    'product-promise-madeineurope-32px',
    PromiseMadeInEurope32
  )
}
if (!customElements.get('product-promise-madeinfrance-32px')) {
  customElements.define(
    'product-promise-madeinfrance-32px',
    PromiseMadeInFrance32
  )
}
...
if (!customElements.get('product-promise-productonpicture-32px')) {
  customElements.define(
    'product-promise-productonpicture-32px',
    PromiseProductOnPicture32
  )
}
if (!customElements.get('product-basket-save-32px')) {
  customElements.define('product-basket-save-32px', BasketSave32)
}
if (!customElements.get('product-promise-productsheet-32px')) {
  customElements.define(
    'product-promise-productsheet-32px',
    PromiseProductSheet32
  )
}
...
if (!customElements.get('product-trolley-32px')) {
  customElements.define('product-trolley-32px', Trolley32)
}
...
if (!customElements.get('service-aftersales-aftersalesservice-32px')) {
  customElements.define(
    'service-aftersales-aftersalesservice-32px',
    AfterSalesAfterSalesService32
  )
}
if (!customElements.get('service-aftersales-helpline-32px')) {
  customElements.define(
    'service-aftersales-helpline-32px',
    AfterSalesHelpline32
  )
}
if (!customElements.get('service-aftersales-satisfaction-32px')) {
  customElements.define(
    'service-aftersales-satisfaction-32px',
    AfterSalesSatisfaction32
  )
}
...
if (!customElements.get('service-custom-cutwoodglass-32px')) {
  customElements.define(
    'service-custom-cutwoodglass-32px',
    CustomCutWoodGlass32
  )
}
if (!customElements.get('service-custom-sample-32px')) {
  customElements.define('service-custom-sample-32px', CustomSample32)
}
...
if (!customElements.get('service-delivery-delivery-pickup--relaypoint-32px')) {
  customElements.define(
    'service-delivery-delivery-pickup--relaypoint-32px',
    DeliveryDeliveryPickupRelayPoint32
  )
}
if (!customElements.get('service-delivery-delivery-pickup--store-32px')) {
  customElements.define(
    'service-delivery-delivery-pickup--store-32px',
    DeliveryDeliveryPickupStore32
  )
}
if (!customElements.get('service-delivery-delivery--home-32px')) {
  customElements.define(
    'service-delivery-delivery--home-32px',
    DeliveryDeliveryHome32
  )
}
if (!customElements.get('service-delivery-delivery--locker-32px')) {
  customElements.define(
    'service-delivery-delivery--locker-32px',
    DeliveryDeliveryLocker32
  )
}
if (!customElements.get('service-purchasehelp-carrent-32px')) {
  customElements.define(
    'service-purchasehelp-carrent-32px',
    PurchaseHelpCarRent32
  )
}
if (!customElements.get('service-purchasehelp-homediy-32px')) {
  customElements.define(
    'service-purchasehelp-homediy-32px',
    PurchaseHelpHomeDIY32
  )
}
if (!customElements.get('service-purchasehelp-homeinstall-32px')) {
  customElements.define(
    'service-purchasehelp-homeinstall-32px',
    PurchaseHelpHomeInstall32
  )
}
if (!customElements.get('service-purchasehelp-toolrent-32px')) {
  customElements.define(
    'service-purchasehelp-toolrent-32px',
    PurchaseHelpToolRent32
  )
}
...
if (!customElements.get('social-comment-question--article-32px')) {
  customElements.define(
    'social-comment-question--article-32px',
    CommentQuestionArticle32
  )
}
...
if (!customElements.get('social-socialnetwork-facebook-32px')) {
  customElements.define(
    'social-socialnetwork-facebook-32px',
    SocialNetworkFacebook32
  )
}
if (!customElements.get('social-socialnetwork-instagram-32px')) {
  customElements.define(
    'social-socialnetwork-instagram-32px',
    SocialNetworkInstagram32
  )
}
if (!customElements.get('social-socialnetwork-linkedin-32px')) {
  customElements.define(
    'social-socialnetwork-linkedin-32px',
    SocialNetworkLinkedin32
  )
}
...
if (!customElements.get('social-socialnetwork-pinterest-32px')) {
  customElements.define(
    'social-socialnetwork-pinterest-32px',
    SocialNetworkPinterest32
  )
}
if (!customElements.get('social-socialnetwork-twitter-32px')) {
  customElements.define(
    'social-socialnetwork-twitter-32px',
    SocialNetworkTwitter32
  )
}
if (!customElements.get('social-socialnetwork-youtube-32px')) {
  customElements.define(
    'social-socialnetwork-youtube-32px',
    SocialNetworkYoutube32
  )
}
...
if (!customElements.get('social-view-like--positive-32px')) {
  customElements.define('social-view-like--positive-32px', ViewLikePositive32)
}
if (!customElements.get('social-view-star--empty-32px')) {
  customElements.define('social-view-star--empty-32px', ViewStarEmpty32)
}
...
if (!customElements.get('store-itinerary-32px')) {
  customElements.define('store-itinerary-32px', Itinerary32)
}
...
if (!customElements.get('store-locator-32px')) {
  customElements.define('store-locator-32px', Locator32)
}
...
if (!customElements.get('store-monochrome-storelocation-bm-32px')) {
  customElements.define(
    'store-monochrome-storelocation-bm-32px',
    MonochromeStoreLocationbm32
  )
}
...
if (!customElements.get('universe-stairs-32px')) {
  customElements.define('universe-stairs-32px', Stairs32)
}
if (!customElements.get('universe-tool-32px')) {
  customElements.define('universe-tool-32px', Tool32)
}
...
if (!customElements.get('user-account-customer--collaborator-32px')) {
  customElements.define(
    'user-account-customer--collaborator-32px',
    AccountCustomerCollaborator32
  )
}
if (!customElements.get('user-account-customer--passion-32px')) {
  customElements.define(
    'user-account-customer--passion-32px',
    AccountCustomerPassion32
  )
}
...
if (!customElements.get('user-account-profile--woman-32px')) {
  customElements.define(
    'user-account-profile--woman-32px',
    AccountProfileWoman32
  )
}
...
if (!customElements.get('user-situation-owner-32px')) {
  customElements.define('user-situation-owner-32px', SituationOwner32)
}
...
if (!customElements.get('various-shutter-32px')) {
  customElements.define('various-shutter-32px', Shutter32)
}
...
if (!customElements.get('various-premium-32px')) {
  customElements.define('various-premium-32px', Premium32)
}
...
if (!customElements.get('instruction-hygiene-nocontact-48px')) {
  customElements.define(
    'instruction-hygiene-nocontact-48px',
    HygieneNoContact48
  )
}
if (!customElements.get('instruction-hygiene-plexiglas-48px')) {
  customElements.define(
    'instruction-hygiene-plexiglas-48px',
    HygienePlexiglas48
  )
}
if (!customElements.get('instruction-payment-checkout-48px')) {
  customElements.define('instruction-payment-checkout-48px', PaymentCheckout48)
}
if (!customElements.get('instruction-payment-nocontact-48px')) {
  customElements.define(
    'instruction-payment-nocontact-48px',
    PaymentNoContact48
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--standinline-48px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--standinline-48px',
    ServicePurchaseHelpCarStandInLine48
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--stayinside-48px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--stayinside-48px',
    ServicePurchaseHelpCarStayInside48
  )
}
if (!customElements.get('instruction-service-purchasehelp-loading-48px')) {
  customElements.define(
    'instruction-service-purchasehelp-loading-48px',
    ServicePurchaseHelpLoading48
  )
}
if (!customElements.get('instruction-service-purchasehelp-nocarrent-48px')) {
  customElements.define(
    'instruction-service-purchasehelp-nocarrent-48px',
    ServicePurchaseHelpNoCarRent48
  )
}
if (!customElements.get('instruction-service-purchasehelp-request-48px')) {
  customElements.define(
    'instruction-service-purchasehelp-request-48px',
    ServicePurchaseHelpRequest48
  )
}
if (!customElements.get('instruction-service-purchasehelp-truck-48px')) {
  customElements.define(
    'instruction-service-purchasehelp-truck-48px',
    ServicePurchaseHelpTruck48
  )
}
if (!customElements.get('instruction-universe-essentialproduct-48px')) {
  customElements.define(
    'instruction-universe-essentialproduct-48px',
    UniverseEssentialProduct48
  )
}
if (!customElements.get('logotypes-payment-monochrome-bizum-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-bizum-48px',
    PaymentMonochromeBizum48
  )
}
if (!customElements.get('logotypes-payment-monochrome-bonificobancario-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-bonificobancario-48px',
    PaymentMonochromeBonificoBancario48
  )
}
if (!customElements.get('logotypes-payment-monochrome-fintecture-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-fintecture-48px',
    PaymentMonochromeFintecture48
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--multibanco-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--multibanco-48px',
    PaymentMonochromeMBMultibanco48
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--way-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--way-48px',
    PaymentMonochromeMBWay48
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney-48px',
    PaymentMonochromeOney48
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--openboot-48px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--openboot-48px',
    ServicePurchaseHelpCarOpenBoot48
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--3x4x-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x4x-48px',
    PaymentMonochromeOney3x4x48
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--4x-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--4x-48px',
    PaymentMonochromeOney4x48
  )
}
if (!customElements.get('logotypes-payment-monochrome-paypal-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-paypal-48px',
    PaymentMonochromePayPal48
  )
}
...
if (!customElements.get('logotypes-payment-monochrome-oney--3x-48px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x-48px',
    PaymentMonochromeOney3x48
  )
}
...
if (!customElements.get('media-image-alt-48px')) {
  customElements.define('media-image-alt-48px', Imagealt48)
}
if (!customElements.get('media-nopicture-48px')) {
  customElements.define('media-nopicture-48px', NoPicture48)
}
...
if (!customElements.get('media-print-48px')) {
  customElements.define('media-print-48px', Print48)
}
if (!customElements.get('media-project-48px')) {
  customElements.define('media-project-48px', Project48)
}
if (!customElements.get('media-push-pin-48px')) {
  customElements.define('media-push-pin-48px', Pushpin48)
}
if (!customElements.get('media-push-pin-off-48px')) {
  customElements.define('media-push-pin-off-48px', Pushpinoff48)
}
...
if (!customElements.get('media-timeread-48px')) {
  customElements.define('media-timeread-48px', TimeRead48)
}
...
if (!customElements.get('navigation-arrow-arrow--bottom-48px')) {
  customElements.define(
    'navigation-arrow-arrow--bottom-48px',
    ArrowArrowBottom48
  )
}
...
if (!customElements.get('navigation-arrow-arrowbottomright-48px')) {
  customElements.define(
    'navigation-arrow-arrowbottomright-48px',
    ArrowArrowBottomRight48
  )
}
if (!customElements.get('navigation-arrow-arrowtopleft-48px')) {
  customElements.define(
    'navigation-arrow-arrowtopleft-48px',
    ArrowArrowTopLeft48
  )
}
if (!customElements.get('navigation-arrow-arrowtopright-48px')) {
  customElements.define(
    'navigation-arrow-arrowtopright-48px',
    ArrowArrowTopRight48
  )
}
...
if (!customElements.get('navigation-arrow-doublearrow--left-48px')) {
  customElements.define(
    'navigation-arrow-doublearrow--left-48px',
    ArrowDoubleArrowLeft48
  )
}
if (!customElements.get('navigation-arrow-doublearrow--right-48px')) {
  customElements.define(
    'navigation-arrow-doublearrow--right-48px',
    ArrowDoubleArrowRight48
  )
}
...
if (!customElements.get('navigation-control-circle--cross-48px')) {
  customElements.define(
    'navigation-control-circle--cross-48px',
    ControlCircleCross48
  )
}
if (!customElements.get('navigation-control-circle--less-48px')) {
  customElements.define(
    'navigation-control-circle--less-48px',
    ControlCircleLess48
  )
}
if (!customElements.get('navigation-control-circle--more-48px')) {
  customElements.define(
    'navigation-control-circle--more-48px',
    ControlCircleMore48
  )
}
...
if (!customElements.get('navigation-display-connect-48px')) {
  customElements.define('navigation-display-connect-48px', DisplayConnect48)
}
if (!customElements.get('navigation-display-displayfull-filled-48px')) {
  customElements.define(
    'navigation-display-displayfull-filled-48px',
    DisplayDisplayFullFilled48
  )
}
if (!customElements.get('navigation-display-displayfull-outline-48px')) {
  customElements.define(
    'navigation-display-displayfull-outline-48px',
    DisplayDisplayFullOutline48
  )
}
if (!customElements.get('navigation-display-displaylist-filled-48px')) {
  customElements.define(
    'navigation-display-displaylist-filled-48px',
    DisplayDisplayListFilled48
  )
}
if (!customElements.get('navigation-display-displaylist-outline-48px')) {
  customElements.define(
    'navigation-display-displaylist-outline-48px',
    DisplayDisplayListOutline48
  )
}
if (!customElements.get('navigation-display-displaymobile--horizontal-48px')) {
  customElements.define(
    'navigation-display-displaymobile--horizontal-48px',
    DisplayDisplayMobileHorizontal48
  )
}
if (!customElements.get('navigation-display-displaymobile--vertical-48px')) {
  customElements.define(
    'navigation-display-displaymobile--vertical-48px',
    DisplayDisplayMobileVertical48
  )
}
if (!customElements.get('navigation-display-displayproductx4-filled-48px')) {
  customElements.define(
    'navigation-display-displayproductx4-filled-48px',
    DisplayDisplayProductX4Filled48
  )
}
if (!customElements.get('navigation-display-displayproductx4-outline-48px')) {
  customElements.define(
    'navigation-display-displayproductx4-outline-48px',
    DisplayDisplayProductX4Outline48
  )
}
if (!customElements.get('navigation-display-displayproductx9-48px')) {
  customElements.define(
    'navigation-display-displayproductx9-48px',
    DisplayDisplayProductX948
  )
}
if (!customElements.get('navigation-display-externallink-48px')) {
  customElements.define(
    'navigation-display-externallink-48px',
    DisplayExternalLink48
  )
}
...
if (!customElements.get('navigation-display-menu-48px')) {
  customElements.define('navigation-display-menu-48px', DisplayMenu48)
}
if (!customElements.get('navigation-display-movingblock-48px')) {
  customElements.define(
    'navigation-display-movingblock-48px',
    DisplayMovingBlock48
  )
}
if (!customElements.get('navigation-display-options-48px')) {
  customElements.define('navigation-display-options-48px', DisplayOptions48)
}
...
if (!customElements.get('navigation-display-screenrotation-48px')) {
  customElements.define(
    'navigation-display-screenrotation-48px',
    DisplayScreenRotation48
  )
}
if (!customElements.get('navigation-display-search-48px')) {
  customElements.define('navigation-display-search-48px', DisplaySearch48)
}
if (!customElements.get('navigation-display-searchlist-48px')) {
  customElements.define(
    'navigation-display-searchlist-48px',
    DisplaySearchList48
  )
}
if (!customElements.get('navigation-display-searchproduct-48px')) {
  customElements.define(
    'navigation-display-searchproduct-48px',
    DisplaySearchProduct48
  )
}
...
if (!customElements.get('navigation-display-vocalsearch-48px')) {
  customElements.define(
    'navigation-display-vocalsearch-48px',
    DisplayVocalSearch48
  )
}
if (!customElements.get('navigation-notification-available-48px')) {
  customElements.define(
    'navigation-notification-available-48px',
    NotificationAvailable48
  )
}
...
if (!customElements.get('navigation-notification-circle--available-48px')) {
  customElements.define(
    'navigation-notification-circle--available-48px',
    NotificationCircleAvailable48
  )
}
if (!customElements.get('navigation-notification-information-48px')) {
  customElements.define(
    'navigation-notification-information-48px',
    NotificationInformation48
  )
}
if (!customElements.get('navigation-notification-question-48px')) {
  customElements.define(
    'navigation-notification-question-48px',
    NotificationQuestion48
  )
}
if (!customElements.get('navigation-notification-warning-48px')) {
  customElements.define(
    'navigation-notification-warning-48px',
    NotificationWarning48
  )
}
...
if (!customElements.get('navigation-publish-favoritefull-48px')) {
  customElements.define(
    'navigation-publish-favoritefull-48px',
    PublishFavoriteFull48
  )
}
...
if (!customElements.get('payment-cards-monochrome-americanexpress-48px')) {
  customElements.define(
    'payment-cards-monochrome-americanexpress-48px',
    CardsMonochromeAmericanExpress48
  )
}
...
if (!customElements.get('payment-cards-monochrome-cheque-48px')) {
  customElements.define(
    'payment-cards-monochrome-cheque-48px',
    CardsMonochromeCheque48
  )
}
if (!customElements.get('payment-cards-monochrome-gift-48px')) {
  customElements.define(
    'payment-cards-monochrome-gift-48px',
    CardsMonochromeGift48
  )
}
if (!customElements.get('payment-cards-monochrome-illicado-48px')) {
  customElements.define(
    'payment-cards-monochrome-illicado-48px',
    CardsMonochromeIllicado48
  )
}
if (!customElements.get('payment-cards-monochrome-loyalty-48px')) {
  customElements.define(
    'payment-cards-monochrome-loyalty-48px',
    CardsMonochromeLoyalty48
  )
}
if (!customElements.get('payment-cards-monochrome-maestro-48px')) {
  customElements.define(
    'payment-cards-monochrome-maestro-48px',
    CardsMonochromeMaestro48
  )
}
if (!customElements.get('payment-cards-monochrome-mastercard-48px')) {
  customElements.define(
    'payment-cards-monochrome-mastercard-48px',
    CardsMonochromeMastercard48
  )
}
if (!customElements.get('payment-cards-monochrome-oney-48px')) {
  customElements.define(
    'payment-cards-monochrome-oney-48px',
    CardsMonochromeOney48
  )
}
if (!customElements.get('payment-cards-monochrome-oneyx3-48px')) {
  customElements.define(
    'payment-cards-monochrome-oneyx3-48px',
    CardsMonochromeOneyX348
  )
}
if (!customElements.get('payment-cards-monochrome-oneyx4-48px')) {
  customElements.define(
    'payment-cards-monochrome-oneyx4-48px',
    CardsMonochromeOneyX448
  )
}
if (!customElements.get('payment-cards-monochrome-paylib-48px')) {
  customElements.define(
    'payment-cards-monochrome-paylib-48px',
    CardsMonochromePaylib48
  )
}
if (!customElements.get('payment-cards-monochrome-paypal-48px')) {
  customElements.define(
    'payment-cards-monochrome-paypal-48px',
    CardsMonochromePaypal48
  )
}
if (!customElements.get('payment-cards-monochrome-visa-48px')) {
  customElements.define(
    'payment-cards-monochrome-visa-48px',
    CardsMonochromeVisa48
  )
}
...
if (!customElements.get('product-promise-certification-48px')) {
  customElements.define(
    'product-promise-certification-48px',
    PromiseCertification48
  )
}
if (!customElements.get('product-promise-circulareconomy-48px')) {
  customElements.define(
    'product-promise-circulareconomy-48px',
    PromiseCircularEconomy48
  )
}
...
if (!customElements.get('product-promise-fashionchoice-48px')) {
  customElements.define(
    'product-promise-fashionchoice-48px',
    PromiseFashionChoice48
  )
}
...
if (!customElements.get('product-promise-madeineurope-48px')) {
  customElements.define(
    'product-promise-madeineurope-48px',
    PromiseMadeInEurope48
  )
}
if (!customElements.get('product-promise-madeinfrance-48px')) {
  customElements.define(
    'product-promise-madeinfrance-48px',
    PromiseMadeInFrance48
  )
}
...
if (!customElements.get('product-promise-productonpicture-48px')) {
  customElements.define(
    'product-promise-productonpicture-48px',
    PromiseProductOnPicture48
  )
}
if (!customElements.get('product-promise-productsheet-48px')) {
  customElements.define(
    'product-promise-productsheet-48px',
    PromiseProductSheet48
  )
}
if (!customElements.get('navigation-arrow-arrowbottomleft-48px')) {
  customElements.define(
    'navigation-arrow-arrowbottomleft-48px',
    ArrowArrowBottomLeft48
  )
}
...
if (!customElements.get('service-aftersales-aftersalesservice-48px')) {
  customElements.define(
    'service-aftersales-aftersalesservice-48px',
    AfterSalesAfterSalesService48
  )
}
if (!customElements.get('service-aftersales-helpline-48px')) {
  customElements.define(
    'service-aftersales-helpline-48px',
...
if (!customElements.get('service-aftersales-satisfaction-48px')) {
  customElements.define(
    'service-aftersales-satisfaction-48px',
    AfterSalesSatisfaction48
  )
}
...
if (!customElements.get('service-custom-cutwoodglass-48px')) {
  customElements.define(
    'service-custom-cutwoodglass-48px',
    CustomCutWoodGlass48
  )
}
...
if (!customElements.get('service-delivery-delivery-pickup--relaypoint-48px')) {
  customElements.define(
    'service-delivery-delivery-pickup--relaypoint-48px',
    DeliveryDeliveryPickupRelayPoint48
  )
}
...
if (!customElements.get('service-delivery-delivery-pickup--store-48px')) {
  customElements.define(
    'service-delivery-delivery-pickup--store-48px',
    DeliveryDeliveryPickupStore48
  )
}
if (!customElements.get('service-delivery-delivery--home-48px')) {
  customElements.define(
    'service-delivery-delivery--home-48px',
    DeliveryDeliveryHome48
  )
}
if (!customElements.get('service-delivery-delivery--locker-48px')) {
  customElements.define(
    'service-delivery-delivery--locker-48px',
    DeliveryDeliveryLocker48
  )
}
if (!customElements.get('service-purchasehelp-carrent-48px')) {
  customElements.define(
    'service-purchasehelp-carrent-48px',
    PurchaseHelpCarRent48
  )
}
if (!customElements.get('service-pallet-48px')) {
  customElements.define('service-pallet-48px', Pallet48)
}
if (!customElements.get('service-purchasehelp-homeinstall-48px')) {
  customElements.define(
    'service-purchasehelp-homeinstall-48px',
    PurchaseHelpHomeInstall48
  )
}
if (!customElements.get('service-purchasehelp-homediy-48px')) {
  customElements.define(
    'service-purchasehelp-homediy-48px',
    PurchaseHelpHomeDIY48
  )
}
...
if (!customElements.get('service-purchasehelp-toolrent-48px')) {
  customElements.define(
    'service-purchasehelp-toolrent-48px',
    PurchaseHelpToolRent48
  )
}
...
if (!customElements.get('social-comment-question--article-48px')) {
  customElements.define(
    'social-comment-question--article-48px',
    CommentQuestionArticle48
  )
}
...
if (!customElements.get('social-share-shareios-48px')) {
  customElements.define('social-share-shareios-48px', ShareShareIOS48)
}
if (!customElements.get('social-socialnetwork-facebook-48px')) {
  customElements.define(
    'social-socialnetwork-facebook-48px',
    SocialNetworkFacebook48
  )
}
if (!customElements.get('social-socialnetwork-instagram-48px')) {
  customElements.define(
    'social-socialnetwork-instagram-48px',
    SocialNetworkInstagram48
  )
}
if (!customElements.get('social-socialnetwork-linkedin-48px')) {
  customElements.define(
    'social-socialnetwork-linkedin-48px',
    SocialNetworkLinkedin48
  )
}
if (!customElements.get('social-socialnetwork-pinterest-48px')) {
  customElements.define(
    'social-socialnetwork-pinterest-48px',
    SocialNetworkPinterest48
  )
}
if (!customElements.get('social-socialnetwork-twitter-48px')) {
  customElements.define(
    'social-socialnetwork-twitter-48px',
    SocialNetworkTwitter48
  )
}
if (!customElements.get('social-socialnetwork-youtube-48px')) {
  customElements.define(
    'social-socialnetwork-youtube-48px',
    SocialNetworkYoutube48
  )
}
...
if (!customElements.get('universe-masonry-alt-48px')) {
  customElements.define('universe-masonry-alt-48px', Masonryalt48)
}
...
if (!customElements.get('user-account-customer--collaborator-48px')) {
  customElements.define(
    'user-account-customer--collaborator-48px',
    AccountCustomerCollaborator48
  )
}
if (!customElements.get('user-account-customer--passion-48px')) {
  customElements.define(
    'user-account-customer--passion-48px',
...
if (!customElements.get('user-account-profile--woman-48px')) {
  customElements.define(
    'user-account-profile--woman-48px',
    AccountProfileWoman48
  )
}
...
if (!customElements.get('user-card-loyaltycard-48px')) {
  customElements.define('user-card-loyaltycard-48px', CardLoyaltyCard48)
}
if (!customElements.get('user-contact-mail-48px')) {
  customElements.define('user-contact-mail-48px', ContactMail48)
}
if (!customElements.get('user-contact-phone-48px')) {
  customElements.define('user-contact-phone-48px', ContactPhone48)
}
if (!customElements.get('user-contact-website-48px')) {
  customElements.define('user-contact-website-48px', ContactWebsite48)
}
if (!customElements.get('user-situation-owner-48px')) {
  customElements.define('user-situation-owner-48px', SituationOwner48)
}
if (!customElements.get('user-situation-tenant-48px')) {
  customElements.define('user-situation-tenant-48px', SituationTenant48)
}
...
if (!customElements.get('various-blower-48px')) {
  customElements.define('various-blower-48px', Blower48)
}
if (!customElements.get('various-company-48px')) {
  customElements.define('various-company-48px', Company48)
}
...
if (!customElements.get('various-level-48px')) {
  customElements.define('various-level-48px', Level48)
}
if (!customElements.get('various-paintcan-48px')) {
  customElements.define('various-paintcan-48px', PaintCan48)
}
...
if (!customElements.get('various-pipe-48px')) {
  customElements.define('various-pipe-48px', Pipe48)
}
...
if (!customElements.get('various-thermalcontrol-48px')) {
  customElements.define('various-thermalcontrol-48px', ThermalControl48)
}
...
if (!customElements.get('instruction-hygiene-nocontact-64px')) {
  customElements.define(
    'instruction-hygiene-nocontact-64px',
    HygieneNoContact64
  )
}
if (!customElements.get('instruction-hygiene-plexiglas-64px')) {
  customElements.define(
    'instruction-hygiene-plexiglas-64px',
    HygienePlexiglas64
  )
}
...
if (!customElements.get('instruction-payment-nocontact-64px')) {
  customElements.define(
    'instruction-payment-nocontact-64px',
    PaymentNoContact64
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--openboot-64px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--openboot-64px',
    ServicePurchaseHelpCarOpenBoot64
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--standinline-64px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--standinline-64px',
    ServicePurchaseHelpCarStandInLine64
  )
}
if (
  !customElements.get('instruction-service-purchasehelp-car--stayinside-64px')
) {
  customElements.define(
    'instruction-service-purchasehelp-car--stayinside-64px',
    ServicePurchaseHelpCarStayInside64
  )
}
if (!customElements.get('instruction-service-purchasehelp-loading-64px')) {
  customElements.define(
    'instruction-service-purchasehelp-loading-64px',
    ServicePurchaseHelpLoading64
  )
}
if (!customElements.get('instruction-service-purchasehelp-nocarrent-64px')) {
  customElements.define(
    'instruction-service-purchasehelp-nocarrent-64px',
    ServicePurchaseHelpNoCarRent64
  )
}
if (!customElements.get('instruction-service-purchasehelp-request-64px')) {
  customElements.define(
    'instruction-service-purchasehelp-request-64px',
    ServicePurchaseHelpRequest64
  )
}
if (!customElements.get('instruction-service-purchasehelp-truck-64px')) {
  customElements.define(
    'instruction-service-purchasehelp-truck-64px',
    ServicePurchaseHelpTruck64
  )
}
if (!customElements.get('instruction-universe-essentialproduct-64px')) {
  customElements.define(
    'instruction-universe-essentialproduct-64px',
    UniverseEssentialProduct64
  )
}
if (!customElements.get('logotypes-payment-monochrome-bizum-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-bizum-64px',
    PaymentMonochromeBizum64
  )
}
...
if (!customElements.get('logotypes-payment-monochrome-fintecture-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-fintecture-64px',
    PaymentMonochromeFintecture64
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--multibanco-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--multibanco-64px',
    PaymentMonochromeMBMultibanco64
  )
}
if (!customElements.get('logotypes-payment-monochrome-mb--way-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-mb--way-64px',
    PaymentMonochromeMBWay64
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney-64px',
    PaymentMonochromeOney64
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--3x4x-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x4x-64px',
    PaymentMonochromeOney3x4x64
  )
}
if (!customElements.get('logotypes-payment-monochrome-oney--4x-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--4x-64px',
    PaymentMonochromeOney4x64
  )
}
if (!customElements.get('logotypes-payment-monochrome-paypal-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-paypal-64px',
    PaymentMonochromePayPal64
  )
}
...
if (!customElements.get('logotypes-payment-monochrome-bonificobancario-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-bonificobancario-64px',
    PaymentMonochromeBonificoBancario64
  )
}
...
if (!customElements.get('media-sound-64px')) {
  customElements.define('media-sound-64px', Sound64)
}
...
if (!customElements.get('logotypes-payment-monochrome-oney--3x-64px')) {
  customElements.define(
    'logotypes-payment-monochrome-oney--3x-64px',
...
if (!customElements.get('navigation-arrow-arrowbottomleft-64px')) {
  customElements.define(
    'navigation-arrow-arrowbottomleft-64px',
    ArrowArrowBottomLeft64
  )
}
if (!customElements.get('navigation-arrow-arrowbottomright-64px')) {
  customElements.define(
    'navigation-arrow-arrowbottomright-64px',
    ArrowArrowBottomRight64
  )
}
if (!customElements.get('navigation-arrow-arrowtopleft-64px')) {
  customElements.define(
    'navigation-arrow-arrowtopleft-64px',
    ArrowArrowTopLeft64
  )
}
if (!customElements.get('navigation-arrow-arrowtopright-64px')) {
  customElements.define(
    'navigation-arrow-arrowtopright-64px',
    ArrowArrowTopRight64
  )
}
...
if (!customElements.get('navigation-arrow-arrow--bottom-64px')) {
  customElements.define(
    'navigation-arrow-arrow--bottom-64px',
    ArrowArrowBottom64
  )
}
...
if (!customElements.get('navigation-control-circle--cross-64px')) {
  customElements.define(
    'navigation-control-circle--cross-64px',
    ControlCircleCross64
  )
}
if (!customElements.get('navigation-control-circle--less-64px')) {
  customElements.define(
    'navigation-control-circle--less-64px',
    ControlCircleLess64
  )
}
if (!customElements.get('navigation-control-circle--more-64px')) {
  customElements.define(
    'navigation-control-circle--more-64px',
    ControlCircleMore64
  )
}
...
if (!customElements.get('navigation-arrow-doublearrow--right-64px')) {
  customElements.define(
    'navigation-arrow-doublearrow--right-64px',
    ArrowDoubleArrowRight64
  )
}
...
if (!customElements.get('navigation-display-displayfull-filled-64px')) {
  customElements.define(
    'navigation-display-displayfull-filled-64px',
    DisplayDisplayFullFilled64
  )
}
if (!customElements.get('navigation-display-displayfull-outline-64px')) {
  customElements.define(
    'navigation-display-displayfull-outline-64px',
    DisplayDisplayFullOutline64
  )
}
if (!customElements.get('navigation-display-displaylist-filled-64px')) {
  customElements.define(
    'navigation-display-displaylist-filled-64px',
    DisplayDisplayListFilled64
  )
}
if (!customElements.get('navigation-display-displaylist-outline-64px')) {
  customElements.define(
    'navigation-display-displaylist-outline-64px',
    DisplayDisplayListOutline64
  )
}
if (!customElements.get('navigation-display-displaymobile--horizontal-64px')) {
  customElements.define(
    'navigation-display-displaymobile--horizontal-64px',
    DisplayDisplayMobileHorizontal64
  )
}
if (!customElements.get('navigation-display-displaymobile--vertical-64px')) {
  customElements.define(
    'navigation-display-displaymobile--vertical-64px',
    DisplayDisplayMobileVertical64
  )
}
...
if (!customElements.get('navigation-display-displayproductx4-outline-64px')) {
  customElements.define(
    'navigation-display-displayproductx4-outline-64px',
    DisplayDisplayProductX4Outline64
  )
}
if (!customElements.get('navigation-display-displayproductx9-64px')) {
  customElements.define(
    'navigation-display-displayproductx9-64px',
    DisplayDisplayProductX964
  )
}
if (!customElements.get('navigation-display-externallink-64px')) {
  customElements.define(
    'navigation-display-externallink-64px',
    DisplayExternalLink64
  )
}
...
if (!customElements.get('navigation-display-productnumb-48px')) {
  customElements.define(
    'navigation-display-productnumb-48px',
    DisplayProductNumb48
  )
}
if (!customElements.get('navigation-display-movingblock-64px')) {
  customElements.define(
    'navigation-display-movingblock-64px',
    DisplayMovingBlock64
  )
}
if (!customElements.get('navigation-display-options-64px')) {
  customElements.define('navigation-display-options-64px', DisplayOptions64)
}
if (!customElements.get('navigation-display-other-64px')) {
  customElements.define('navigation-display-other-64px', DisplayOther64)
}
if (!customElements.get('navigation-display-displayproductx4-filled-64px')) {
  customElements.define(
    'navigation-display-displayproductx4-filled-64px',
    DisplayDisplayProductX4Filled64
  )
}
if (!customElements.get('navigation-display-productnumb-64px')) {
  customElements.define(
    'navigation-display-productnumb-64px',
    DisplayProductNumb64
  )
}
...
if (!customElements.get('navigation-arrow-doublearrow--left-64px')) {
  customElements.define(
    'navigation-arrow-doublearrow--left-64px',
    ArrowDoubleArrowLeft64
  )
}
if (!customElements.get('navigation-display-screenrotation-64px')) {
  customElements.define(
    'navigation-display-screenrotation-64px',
    DisplayScreenRotation64
  )
}
...
if (!customElements.get('navigation-display-searchlist-64px')) {
  customElements.define(
    'navigation-display-searchlist-64px',
    DisplaySearchList64
  )
}
if (!customElements.get('navigation-display-searchproduct-64px')) {
  customElements.define(
    'navigation-display-searchproduct-64px',
    DisplaySearchProduct64
  )
}
...
if (!customElements.get('navigation-display-vocalsearch-64px')) {
  customElements.define(
    'navigation-display-vocalsearch-64px',
    DisplayVocalSearch64
  )
}
if (!customElements.get('navigation-notification-available-64px')) {
  customElements.define(
    'navigation-notification-available-64px',
    NotificationAvailable64
  )
}
...
if (!customElements.get('navigation-notification-information-64px')) {
  customElements.define(
    'navigation-notification-information-64px',
    NotificationInformation64
  )
}
if (!customElements.get('navigation-notification-question-64px')) {
  customElements.define(
    'navigation-notification-question-64px',
    NotificationQuestion64
  )
}
if (!customElements.get('navigation-notification-warning-64px')) {
  customElements.define(
    'navigation-notification-warning-64px',
    NotificationWarning64
  )
}
...
if (!customElements.get('navigation-publish-favoritefull-64px')) {
  customElements.define(
    'navigation-publish-favoritefull-64px',
    PublishFavoriteFull64
  )
}
...
if (!customElements.get('product-promise-certification-64px')) {
  customElements.define(
    'product-promise-certification-64px',
    PromiseCertification64
  )
}
if (!customElements.get('product-promise-circulareconomy-64px')) {
  customElements.define(
    'product-promise-circulareconomy-64px',
    PromiseCircularEconomy64
  )
}
...
if (!customElements.get('product-promise-fashionchoice-64px')) {
  customElements.define(
    'product-promise-fashionchoice-64px',
    PromiseFashionChoice64
  )
}
...
if (!customElements.get('product-promise-madeineurope-64px')) {
  customElements.define(
    'product-promise-madeineurope-64px',
    PromiseMadeInEurope64
  )
}
if (!customElements.get('product-promise-madeinfrance-64px')) {
  customElements.define(
    'product-promise-madeinfrance-64px',
    PromiseMadeInFrance64
  )
}
...
if (!customElements.get('product-promise-productonpicture-64px')) {
  customElements.define(
    'product-promise-productonpicture-64px',
    PromiseProductOnPicture64
  )
}
if (!customElements.get('product-promise-productsheet-64px')) {
  customElements.define(
    'product-promise-productsheet-64px',
...
if (!customElements.get('service-aftersales-aftersalesservice-64px')) {
  customElements.define(
    'service-aftersales-aftersalesservice-64px',
    AfterSalesAfterSalesService64
  )
}
if (!customElements.get('service-aftersales-helpline-64px')) {
  customElements.define(
    'service-aftersales-helpline-64px',
    AfterSalesHelpline64
  )
}
...
if (!customElements.get('service-aftersales-satisfaction-64px')) {
  customElements.define(
    'service-aftersales-satisfaction-64px',
    AfterSalesSatisfaction64
  )
}
...
if (!customElements.get('service-custom-cutwoodglass-64px')) {
  customElements.define(
    'service-custom-cutwoodglass-64px',
    CustomCutWoodGlass64
  )
}
...
if (!customElements.get('service-delivery-delivery-pickup--relaypoint-64px')) {
  customElements.define(
    'service-delivery-delivery-pickup--relaypoint-64px',
    DeliveryDeliveryPickupRelayPoint64
  )
}
if (!customElements.get('service-delivery-delivery-pickup--store-64px')) {
  customElements.define(
    'service-delivery-delivery-pickup--store-64px',
    DeliveryDeliveryPickupStore64
  )
}
if (!customElements.get('service-delivery-delivery--home-64px')) {
  customElements.define(
    'service-delivery-delivery--home-64px',
    DeliveryDeliveryHome64
  )
}
if (!customElements.get('service-delivery-delivery--locker-64px')) {
  customElements.define(
    'service-delivery-delivery--locker-64px',
    DeliveryDeliveryLocker64
  )
}
...
if (!customElements.get('service-purchasehelp-carrent-64px')) {
  customElements.define(
    'service-purchasehelp-carrent-64px',
    PurchaseHelpCarRent64
  )
}
if (!customElements.get('service-purchasehelp-homediy-64px')) {
  customElements.define(
    'service-purchasehelp-homediy-64px',
    PurchaseHelpHomeDIY64
  )
}
if (!customElements.get('service-purchasehelp-homeinstall-64px')) {
  customElements.define(
    'service-purchasehelp-homeinstall-64px',
    PurchaseHelpHomeInstall64
  )
}
if (!customElements.get('service-purchasehelp-toolrent-64px')) {
  customElements.define(
    'service-purchasehelp-toolrent-64px',
    PurchaseHelpToolRent64
  )
}
...
if (!customElements.get('social-comment-question--article-64px')) {
  customElements.define(
    'social-comment-question--article-64px',
    CommentQuestionArticle64
  )
}
...
if (!customElements.get('social-socialnetwork-facebook-64px')) {
  customElements.define(
    'social-socialnetwork-facebook-64px',
    SocialNetworkFacebook64
  )
}
if (!customElements.get('social-socialnetwork-instagram-64px')) {
  customElements.define(
    'social-socialnetwork-instagram-64px',
    SocialNetworkInstagram64
  )
}
if (!customElements.get('social-socialnetwork-linkedin-64px')) {
  customElements.define(
    'social-socialnetwork-linkedin-64px',
    SocialNetworkLinkedin64
  )
}
if (!customElements.get('social-socialnetwork-pinterest-64px')) {
  customElements.define(
    'social-socialnetwork-pinterest-64px',
    SocialNetworkPinterest64
  )
}
if (!customElements.get('social-socialnetwork-twitter-64px')) {
  customElements.define(
    'social-socialnetwork-twitter-64px',
    SocialNetworkTwitter64
  )
}
if (!customElements.get('social-socialnetwork-youtube-64px')) {
  customElements.define(
    'social-socialnetwork-youtube-64px',
    SocialNetworkYoutube64
  )
}
...
if (!customElements.get('store-map-64px')) {
  customElements.define('store-map-64px', Map64)
}
if (!customElements.get('store-monochrome-relaylocation-64px')) {
  customElements.define(
    'store-monochrome-relaylocation-64px',
    MonochromeRelayLocation64
  )
}
if (!customElements.get('store-monochrome-storelocation-64px')) {
  customElements.define(
    'store-monochrome-storelocation-64px',
    MonochromeStoreLocation64
  )
}
if (!customElements.get('store-monochrome-storelocation-bm-64px')) {
  customElements.define(
    'store-monochrome-storelocation-bm-64px',
    MonochromeStoreLocationbm64
  )
}
...
if (!customElements.get('universe-drill-alt-64px')) {
  customElements.define('universe-drill-alt-64px', Drillalt64)
}
if (!customElements.get('universe-electricity-64px')) {
  customElements.define('universe-electricity-64px', Electricity64)
}
...
if (!customElements.get('universe-hard-hat-alt-64px')) {
  customElements.define('universe-hard-hat-alt-64px', Hardhatalt64)
}
...
if (!customElements.get('universe-living-64px')) {
  customElements.define('universe-living-64px', Living64)
}
...
if (!customElements.get('user-account-customer--passion-64px')) {
  customElements.define(
    'user-account-customer--passion-64px',
    AccountCustomerPassion64
  )
}
...
if (!customElements.get('user-account-profile--woman-64px')) {
  customElements.define(
    'user-account-profile--woman-64px',
    AccountProfileWoman64
  )
}
...
if (!customElements.get('user-contact-website-64px')) {
  customElements.define('user-contact-website-64px', ContactWebsite64)
}
if (!customElements.get('user-situation-owner-64px')) {
  customElements.define('user-situation-owner-64px', SituationOwner64)
}
if (!customElements.get('user-situation-tenant-64px')) {
  customElements.define('user-situation-tenant-64px', SituationTenant64)
}
if (!customElements.get('various-a11y-64px')) {
  customElements.define('various-a11y-64px', A11y64)
}
if (!customElements.get('various-administration-64px')) {
  customElements.define('various-administration-64px', Administration64)
}
if (!customElements.get('various-apartment-64px')) {
  customElements.define('various-apartment-64px', Apartment64)
}
...
if (!customElements.get('user-account-customer--collaborator-64px')) {
  customElements.define(
    ...
    AccountCustomerCollaborator64
  )
}
if (!customElements.get('various-house-64px')) {
  customElements.define('various-house-64px', House64)
}
if (!customElements.get('various-heat-64px')) {
  customElements.define('various-heat-64px', Heat64)
}
...
if (!customElements.get('various-paintcan-64px')) {
  customElements.define('various-paintcan-64px', PaintCan64)
}
if (!customElements.get('various-increasevalue-64px')) {
  customElements.define('various-increasevalue-64px', IncreaseValue64)
}
if (!customElements.get('various-partnercompany-64px')) {
  customElements.define('various-partnercompany-64px', PartnerCompany64)
}
