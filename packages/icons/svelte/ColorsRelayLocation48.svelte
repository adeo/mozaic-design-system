...
<svg aria-hidden="true" width={size} height={size} id={id}  style={style} class={className} fill={fill} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
  ...
  <path fill="#fff" d="m29 15.85 3-1.76-7-4.15a2 2 0 0 0-2 0l-1.92 1.14L29 15.85Zm-14-.03 8 4.75v9.5l-7-4.17a2 2 0 0 1-1-1.72v-8.36Zm10 14.25v-9.5l8-4.75v8.36a2 2 0 0 1-1 1.72l-7 4.17Zm-9-15.98 3.11-1.85 7.97 4.77L24 18.84l-8-4.75Z"/>
</svg>
