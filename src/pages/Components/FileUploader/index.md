...
After uploading a file, a tile is added to the bottom of the file upload component.
This tile allows the user to see the file name and its status :

- Uploaded
- Error

-- PREVIEW FILE UPLOADER avec lame uploaded & error --
