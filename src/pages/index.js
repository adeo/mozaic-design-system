...
const Tile = ({ icon, center, title, text, linkurl, link, children }) => (
  <div className="gl-flexy__col section__tile">
    <div className={`${center ? 'tile tile--center' : 'tile'}`}>
      ...
      <Link className="tile__link" to={linkurl}>
        {link}
      </Link>
      {children}
    </div>
...
const Section = ({ children, title }) => (
  <div className="section">
    <h2 className="section__title gl-flexy__col--11of12@from-m  gl-flexy__col--push-1of12@from-m">
      {title}
    </h2>
...
const IndexPage = () => (
  <main className="mozaic">
    <Slice dark large>
      <ul class="help gl-flexy gl-flexy__col-1of2 gl-flexy__col--push-1of2 gl-flexy__col--1of6@from-l gl-flexy__col--push-5of6@from-l">
        <Linkicon link="/">
          <svg
    ...
    <Slice large>
      <div className="gl-flexy more">
        <Link to="/" className="more__arrow" />
      </div>
      <Section title="Get started">
        <div className="gl-flexy gl-flexy--items-stretch gl-flexy--gutter">
          <Tile
            center
            title="Designers"
      ...
      <Section title="Design language">
        <div className="gl-flexy gl-flexy--items-stretch gl-flexy--gutter">
          ...
          <Tile
            center
            title="Components"
            text="All the visual components needed to layout an interaction. So far, we have only forms and buttons. You can be part of it and help to increase this list in no time."
            linkurl="/getstarted"
            link="Discover"
          />
        </div>
    ...
    <Slice large>
      <Section title="Ressources">
        <div className="gl-flexy gl-flexy--items-stretch gl-flexy--gutter">
          ...
          >
            <p class="tile__description--italic">
              Please read{' '}
    ...
    <Slice>
      <div className="section">
        <div className="section__content">
          <div className="contact gl-flexy gl-flexy--gutter">
            <div className="contact__picture gl-flexy__col--1of3@from-m" />
            <div className="contact__infos gl-flexy__col--2of3@from-m">
