...
Our Figma Organisation is divided into several teams, dedicated to the platforms and Business Units, and each component library is already set up according to the brand or scope. You will find everything you need inside the `Assets` panel.
