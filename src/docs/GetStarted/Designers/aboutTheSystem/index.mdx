...
_As designers_, the **Mozaic design system** provides you with a lot of ready to use **patterns**.
...
It can be applied or modified to meet a specific design problem, a user needs, evoke an emotion, reinforce the brand management.
