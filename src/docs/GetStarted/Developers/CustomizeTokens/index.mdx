...
You can see that we build variables but also a sass map. The map is usefull when we need to loop through values to create multiple variations of a pattern. More infos about that on chapter 5.
