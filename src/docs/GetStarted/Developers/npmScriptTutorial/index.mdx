...
note that you need to follow the ITCSS/ADS [import order](/GetStarted/Developers/Installation/import/)
...
Please read [our guidelines](Contributing/Developers/CSSConventions/) to write CSS that follows our conventions.
