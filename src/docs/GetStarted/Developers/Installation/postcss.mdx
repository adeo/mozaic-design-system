...
<Highlight theme="warning" title="Stylelint support">

Mozaic is no longer offering stylelint and autoprefixer plugins out of the box.

If needed you can use our stylelint config in your environment. 

Export Mozaic stylelint config file to your `stylelint.config.js`
