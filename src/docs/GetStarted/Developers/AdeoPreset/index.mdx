...
To use the **Adeo preset**, you must create at the root of your project a file `mozaic.config.js` _(if it does not already exist)_ and follow these steps:
...
To make it easier for you to see and use these tokens, you must define your local token export path. To do this, you must add the following code to the `mozaic.config.js` file, in addition to the elements already included:
...
To compile tokens, you have two options:
