...
> **Important note** : Using postCSS with the following configuration **is mandatory for us to garanty Mozaic to work as advertised**. Not following the instructions may cause Mozaic CSS to break silently either now or at some point in the future as new features and bug fixes are published.
