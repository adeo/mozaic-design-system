...
After checking all these points, you can now create your new pattern: [Submit a new pattern](http://mozaic.adeo.cloud/Contributing/NewPattern/SubmitNewPattern/).