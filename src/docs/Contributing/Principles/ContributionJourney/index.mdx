...
### ❓ What?
The kick-off is the time where the designer and the developer sit alongside with Mozaic and LEROY MERLIN's teams. This time is very crucial because both teams will explain the duo what's expected from them. We like to do this event **in real life**. This phase will be a workshop led by Mozaic and LEROY MERLIN core teams.
