...
Making the web accessible benefits individuals, businesses, and society. International web standards define what is needed for accessibility. [Learn more here](https://www.w3.org/WAI/fundamentals/accessibility-intro/)
...
Branching, in version control and software configuration management, is the duplication of an object under version control so that modifications can occur in parallel along multiple branches. [Learn more here](https://help.github.com/en/articles/about-branches)
...
Design tokens are UI pieces of information that store visual design attributes, such as values for margins and spacing, font sizes and families, or color values. [Learn more here](https://www.youtube.com/watch?v=wDBEc3dJJV8)
...
A simple way for non-programming types to write in an easy-to-read format that could be converted directly into HTML. [Learn more here](https://en.wikipedia.org/wiki/Markdown#Example)
