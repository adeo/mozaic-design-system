...
It's important to discuss your needs and what can be produced together before starting to create the said icon. Our icon designer is [Simon Roger](mailto:simon.roger@ext.leroymerlin.fr) for now. Get in touch with him to speak about format and sizes of your icon(s).
...
You must create a branch to be able to push your work in Mozaic's design system repository. We advise you to name it like this `YYWW-icons` (1949-icons) to be meaningful and consistent.

## 4. Place your icon(s) in Mozaic's repository

Your icon needs to put in the **design-system--styleguide** repository in this folder `/src/Icons/YourSize`.
...
To be available, your branch needs to have a commit and be pushed. Please read [our commit guidelines](http://mozaic.adeo.cloud/Contributing/Developers/GitConventions/#commit-message) for more efficiency.
