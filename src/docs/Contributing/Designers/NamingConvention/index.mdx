...
We use two letters prefixes to name our files, this two letters depending on the pattern type and look like that: **_[XX] File name.sketch_**
...
- We use clothes sizes letters to organize the patterns from the smallest to the biggest. For example, `XS`, `S`, `M`, `L`,`XL`.
