...
Mozaic is a design system for Adeo Group brands. Therefore, all Mozaic projects must be in line with the group's strategy, concerning the technologies used and to be favoured within the company.
