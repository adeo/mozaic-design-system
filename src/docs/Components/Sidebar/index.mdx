...
> The Sidebar component is a vertical navigation element used in digital products for quick access to top-level features, designed to save space and maintain focus on features and business gestures. It is typically combined with the [Page header component](/components/page-header/) to structure the user experience in digital products and portals.
...
To keep consistency, the [Page header](/components/page-header/) title must be the same than the sidebar entry name.
