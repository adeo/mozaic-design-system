...
links:
  vue:
    link: 'https://adeo.github.io/mozaic-vue/?path=/story/components-moptioncard'
    status: 'ready'
  freemarker:
    link: 'https://solid-bassoon-011c369c.pages.github.io/pages/3_Components/option-group/option-card/'
    status: 'ready'
  react:
    status: 'ready'
    link: 'https://adeo.github.io/mozaic-react/?path=/story/components-OptionCard'
