...
However, you have the possibility to make this element visible if needed ([read more about this above](/components/progress-bar/code/#percentage-progress)).
...
We recommend that you [read the page dedicated to the accessibility of this component](/components/progress-bar/accessibilty/) in order to learn more.
