...
<span class="mc-tag-removable">
  ...
  <button class="mc-tag-removable__remove" aria-label="delete tag xxx"></button>
</span>
```

<Preview path="TagRemovable" />

#### Accessibility and semantic

<HintItem>
  Always use aria-label that describe the tag to be removed and the associated
