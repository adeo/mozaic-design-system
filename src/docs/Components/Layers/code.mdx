...
- **A header** with the class : `mc-layer__header`
- **A body** with class: `mc-layer__body`
- **A footer** with class: `mc-layer__footer`
...
- A `mc-layer-overlay` element is generated in the DOM.

## Accessibility

<HintItem>
  The layer container (mc-layer) must always have a{' '}
