...
By structuring data in this format, tables provide an intuitive and efficient way to browse and analyse complex amounts of information.  
...
Labels are always at the top of the table and in capital letters to differentiate them from the data.  
