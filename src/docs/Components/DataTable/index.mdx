...
links:
  vue:
    link: 'https://adeo.github.io/mozaic-vue/?path=/story/components-mdatatable'
    status: 'ready'
  webComponent:
    status: 'ready'
    link: 'https://ubiquitous-giggle-7b5b6e33.pages.github.io/?path=/story/components-datatable'
  react:
    status: 'ready'
    link: 'https://adeo.github.io/mozaic-react/?path=/story/components-datatable'
status:
  figma: 'ready'
  scss: 'ready'
---
