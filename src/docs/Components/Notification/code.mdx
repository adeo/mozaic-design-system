...
<div class="mc-notification">
  <div class="mc-notification__content">
    ...
    <div class="mc-notification__footer">
      <a class="mc-link mc-link--s" href="#">Link</a>
    </div>
  </div>
</div>
```
...
In order to keep the display of the component harmonious, please note that the link added to the **Notification** component must be [a .mc-link in size S](/Components/Links/code/#available-sizes).
