...
For this you have to add to the label the `mc-accordion__label--icon` modifier.
...
Then just add the CSS class `mc-accordion__selectable` to your toogle.

```html
<div class="mc-accordion">
  <input type="checkbox" id="toggle" class="mc-accordion__trigger" />
  <label
    class="
      mc-accordion__label mc-accordion__header
    "
    for="toggle"
  >
    <div class="mc-toggle mc-accordion__selectable">
      <input class="mc-toggle__input" id="toggle" type="checkbox" />
      <label class="mc-toggle__label" for="toggle"> </label>
    </div>
    <span aria-expanded="false">Accordion with toggle </span>
  </label>
  <div class="mc-accordion__content">
    <p>
...
```html
<div class="mc-accordion">
  <input type="checkbox" id="checkable" class="mc-accordion__trigger" />
  <label class="mc-accordion__label mc-accordion__header" for="checkable">
    ...
    <span
      class="mc-accordion__label--checkable"
      aria-expanded="false"
    >
