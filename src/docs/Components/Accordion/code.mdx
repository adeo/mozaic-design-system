...
### With Checkbox or Toogle

You can add a Mozaic checkbox or toggle into any accordions you want.

For this you have to add to the label the `mc-accordion__label--selectable` modifier.

Then just add the CSS class `mc-accordion__selectable` to your toogle or checkbox.
...
```html
  <div class="mc-accordion">
    ...
    <label
      for="icon"
      class="mc-accordion__label mc-accordion__label--selectable"
      aria-expanded="false"
    >
