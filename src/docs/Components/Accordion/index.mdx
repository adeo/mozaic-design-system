...
links: 
  vue: 'https://adeo.github.io/mozaic-vue/?path=/story/components-mbutton--try-it'
  freemarker: 'https://adeo.github.io/mozaic-vue/?path=/story/components-mbutton--try-it'
  react: 'https://adeo.github.io/mozaic-vue/?path=/story/components-mbutton--try-it'
status:
  sketch: 'bêta'
  scss: 'bêta'
---
