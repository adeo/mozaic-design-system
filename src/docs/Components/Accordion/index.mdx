...
links:
  vue:
    link: 'https://adeo.github.io/mozaic-vue/?path=/story/components-maccordion--try-it'
    status: 'ready'
  freemarker:
    status: 'ready'
    link: 'https://adeo.github.io/mozaic-freemarker/pages/3_Components/accordion/'
status:
  sketch: 'ready'
  scss: 'ready'
---
...
We designed accordions with modularity in mind. You will find two different font-sizes for the accordions text content. The smallest value is `16px (1mu)` and the regular value is `18px`.

---------add small & medium previews----------

<Highlight theme="warning" title="Be aware">

Always think about accessibility when you use smaller text content sizes.
