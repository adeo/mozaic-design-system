...
We designed accordions with modularity in mind. You will find two different font-sizes for the accordions text content. The smallest value is `1mu (16px)` and the regular value is `18px`.
