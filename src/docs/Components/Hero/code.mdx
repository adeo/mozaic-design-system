...
The title of your component must be a [Mozaic's Heading](/components/heading/) and must therefore have the following structure:
...
> Note that the **Heading** you use in the **Hero** component must always be an [underlined heading](/components/heading/#underlined-headings).
