...
<u>The <strong>mc-hero--with-boxed</strong> modifier</u>
<br/>
...
<u>The <strong>mc-hero--boxed-bottom</strong> modifier</u>

By default the boxed content is positioned next to the main content from the screen size **l** _(1024px)_.

However, there may be times when you need to leave the boxed content below the main area. To do this, you can use the `mc-hero--boxed-bottom` modifier.

<Preview path="boxed-content-bottom" />