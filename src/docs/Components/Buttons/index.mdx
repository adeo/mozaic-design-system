...
You can use `primary` (default), `invert`, `secondary`, `secondary-invert`, `accent`, `danger` and `danger-invert` theme . These declinations can help you to make what's important stand out.
