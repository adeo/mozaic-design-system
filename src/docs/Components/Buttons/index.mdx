...
links:
  vue:
    link: 'https://adeo.github.io/mozaic-vue/?path=/story/components-mbutton--try-it'
    status: 'ready'
  freemarker:
    status: 'ready'
    link: 'https://adeo.github.io/integration-web-core--socle/pages/Components/buttons/'
status:
  sketch: 'ready'
  figma: 'ready'
  scss: 'ready'
