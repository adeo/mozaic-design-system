...
```html
<a href="#" class="mc-button mc-button--primary-02">
  <span class="mc-button__label">
    Label
  </span>
</a>
<a href="#" class="mc-button mc-button--bordered-primary-02">
  <span class="mc-button__label">
    Label
  </span>
</a>
...
<Preview path="button-widths-responsive" />
...
<Preview path="button-icon-and-text" />
...
Read our [customization doc first](GetStarted/Developers/CustomizeTokens/) first to see how to customize tokens.
