...
<Preview path="stars-input-basic" />
...
<Preview path="stars-input-all-sizes" />
...
<Preview path="stars-result-basic" />
...
<Preview path="stars-result-all-sizes" />

#### With a label

You have the possibility to display a text explicitly telling the user the result of the note.
...
<Preview path="stars-result-label" nude />
...
<Preview path="stars-result-label-link" nude />
...
<Preview path="stars-result-overall" nude />
