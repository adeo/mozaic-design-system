...
![spec visual medium](inputs-documentation--medium.png)

### Small

![spec visual small](inputs-documentation--small.png)

## Properties

### CSS Tokens : layout / sizes

| Size name                   | Paddings      | Font-size             | Line-height             | radius           |
| --------------------------- | ------------- | --------------------- | ----------------------- | ---------------- |
| **Small**                   | 8px (mu050)   | `size.font.04` (14px) | `size.line.04.l` (22px) | `radius.m` (4px) |
| **Medium** _(Default size)_ | 12px (mu075)  | `size.font.05` (16px) | `size.line.05.l` (24px) | `radius.m` (4px) |
...
<Preview path="input-default-disabled" />
