...
<div class="mc-modal" tabindex="-1" role="dialog">
  <div class="mc-modal__dialog" role="document">
    <div class="mc-modal__header">
      <div class="mc-modal__title">Modale Title</div>
...
- The **header** contains:
  ...
  - as well as its close button _(`.mc-modal__close`)_
    _(These elements are mandatory and must always be present in your modal code.)_

- The body can contain:

  - a heading _(`.mc-modal__heading`)_
  - as well as paragraph elements _(`.mt-body-m`)_
    _(Note that the heading is an optional element)_
