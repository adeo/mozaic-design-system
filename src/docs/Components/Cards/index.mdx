...
title: 'Cards'
order: 1
description: 'A card is a navigation element that structures a group of related informations that must be understood on its own. It visually looks like a playing card.'
status:
  sketch: 'wip'
  scss: 'wip'
---
