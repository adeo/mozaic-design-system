...
A card can be more complex in some cases and needs to provide more explanations using an optionnal **subtitle** or an **action area**. You can see that cards in Mozaic have two different action areas that you can choose.
