...
@import 'components/_c.button'; // (Optionnal)
...
<nav class="mc-pagination" role="navigation" aria-label="pagination">
  <button href="#" class="mc-button mc-button--solid-neutral mc-button--square mc-button--s@from-l" aria-label="Previous page">
  ...
  <button button href="#" class="mc-button mc-button--solid-neutral mc-button--square mc-button--s@from-l" aria-label="Next Page">
    <svg class="mc-button__icon">
...
<Preview path="pagination-compact" />
