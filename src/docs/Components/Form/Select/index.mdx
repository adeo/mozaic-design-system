...
links: 
  vue:
    link: 'https://adeo.github.io/mozaic-vue/?path=/story/components-mselect--try-it'
    status: 'ready'
  freemarker:
    status: 'ready'
    link: 'https://adeo.github.io/integration-web-core--socle/pages/Components/form/select/'
status:
  sketch: 'ready'
  scss: 'ready'
  figma: 'ready'
