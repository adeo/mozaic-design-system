...
links:
  vue:
    link: 'https://adeo.github.io/mozaic-vue/?path=/story/components-mtoggle--try-it'
    status: 'bêta'
  freemarker:
    status: 'bêta'
    link: 'https://adeo.github.io/integration-web-core--socle/pages/Components/form/switch/'
status:
  sketch: 'stable'
  scss: 'stable'
---
...
<Highlight theme="warning" title="Be aware">
  Please think well about the toggle use and its label. For remind, a toggle is used to have instant feedback, use a short label is the best way.
</Highlight>

-- Add preview with text on two lines --
