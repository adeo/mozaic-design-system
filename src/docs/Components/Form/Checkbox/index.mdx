...
<Highlight theme="warning">
  ...
  A checkbox can't live without an associated label.
...
Checkbox group is a combination of the following mentions. Please note that you can use five different cases:
