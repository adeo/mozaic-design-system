...
### Use radio with suffix

To use the radio with a suffix label, you have to add `mc-radio__suffix-label` inside the label element. 

```html
  <label for="radio-01" class="mc-radio__label">
    My label
    <span class="mc-radio__suffix-label" >(my suffix)</span>
  </label>
```
