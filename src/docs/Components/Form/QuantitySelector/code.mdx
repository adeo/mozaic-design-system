...
<div class="mc-quantity-selector">
	<button class="mc-button mc-button--square mc-button--bordered mc-quantity-selector__button-left" aria-controls="qty-selector" aria-label="Decrement">
	...
	<button aria-controls="qty-selector" class="mc-button mc-button--square mc-button--bordered mc-quantity-selector__button-right" aria-label="Increment">
		<svg class="mc-button__icon">
...
## With label
When using the QuantitySelector component with a label, you have to import the **fields** scss file in addition to the other stylesheets.
