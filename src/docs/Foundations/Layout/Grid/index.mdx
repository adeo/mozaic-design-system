...
Columns and gutters form a container. The container can be **full or fixed width.**
...
<HintItem>
    An element should always stand on one or several columns.
</HintItem>
<HintItem>
...
We work with **12-columns grids** because the number 12 is the most versatile. 12 is divisible among reasonably small numbers; it’s possible to have 12, 6, 4, 3, 2 or 1 evenly spaced columns. This gives designers a lot of flexibility to create a layout.
