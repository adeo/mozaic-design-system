...
You can add to your bundle the margins or paddings utility classes like so :
...
Please consider that those utilities are looping through all magic-unit authorized values up to 10x magic-units (160px), and through all possible sides (left, top, right, bottom). This will result in a lot of classes that you will potentially not use.
...
You can implement your own margins or paddings utilities using the space mixin :
...
<HintItem>
    Use margins and paddings variables or functions to define inner spaces
</HintItem>
...
It makes it easier for your coworker to understant what is related.
