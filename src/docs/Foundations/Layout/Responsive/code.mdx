...
<HintItem>
  Use the set-from-screen mixin in with a screen map key to create a media query.
</HintItem>
...
### To modify the screen **take a map as an argument**.
...
<HintItem>
  Use the screen variables to get the <b>px</b> value of a screen size.
</HintItem>
