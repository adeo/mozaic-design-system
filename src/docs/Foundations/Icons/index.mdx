...
Icons allows to emphasise an action and make it easier to understand. An icon can be used in a button without a label to save space in interfaces.
...
Close icons are very well known by users to close panels or delete options.

#### 5. Illustration and informative

Icons are used to preview detailed information.
