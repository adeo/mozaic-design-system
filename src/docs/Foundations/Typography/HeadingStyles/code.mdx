...
> Default line-heights for the headings familly are set to `M`, which corresponds to a ratio close to 1.35.
...
> Headings atoms sizes change at the 'M' viewport, which corresponds to tablet sizes.
