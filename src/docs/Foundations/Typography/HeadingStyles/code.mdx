...
**Semi-bold** an **light** variations are available by applying the `mt-heading--semi-bold` `mt-heading--light` modifiers.
...
- **Primary 02** `mt-heading--underline mt-heading--line-primary-02-600`

#### Underlines that could be used with a dark background

- **Default / primary 01** `mt-heading--underline`
- **Primary 02 200** `mt-heading--underline mt-heading--line-primary-02-600`
- **primary 01 200** `mt-heading--underline mt-heading--line-primary-02-600`
