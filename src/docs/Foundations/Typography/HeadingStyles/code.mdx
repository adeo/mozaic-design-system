...
<Preview path="typographyHeading-sizes" />
...
<Highlight theme="tips" title="Default margin">
...
<Preview path="typographyHeading-weight"  />
...
<Preview path="typographyHeading-colors" />

### Underlines

Add underlines by applying the `mt-heading--underline` modifier.

<Highlight theme="tips" title="Important note">
...
- **Primary 02 600**: `mt-heading--underline mt-heading--line-primary-02-600`

#### Underlines that could be used with a dark background

- **Default / primary 01**: `mt-heading--underline`
- **primary 01 200**: `mt-heading--underline mt-heading--line-primary-01-200`
- **Primary 02 200**: `mt-heading--underline mt-heading--line-primary-02-200`


<Preview path="typographyHeading-underlines" />
...
<Preview path="typographyHeading-alignment" />
