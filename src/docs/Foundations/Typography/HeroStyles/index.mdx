...
> <br />
> They are mostly used with a picture or color in the background.
...
|                                                                                                |                                                                                                                                                                                                           |
| ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Preview path="typographyHero" /> | **Hero** <br /> Viewport < M (576px) : 34px (2.125mu ) <br /> Viewport >= M (576px) : 41px (2.5625mu) <br /> Viewport >= L (1100px) : 49px (3.0625mu) <br /> Viewport >= L-MEDIUM (1440px) : 59px (3.6875mu) <br /> |

## Do's and don'ts

<HintItem dont>
    A hero <b>can't be used in combination with a heading large</b> because they share the same size on some viewports.
</HintItem>
