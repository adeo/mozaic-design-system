...
> **Body classes font-size do not vary depending on the viewport**, because those font-sizes are optimized for any viewport.
...
<Preview path="typographyBody-variations" />

| Class name                             | font-size (any viewport) | line-height          | weight    |
| -------------------------------------- | ------------------------ | -------------------- | --------- |
| **body L**                             |
