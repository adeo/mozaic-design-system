...
> As a reminder, you can define an environment variable to determine whether you want to use Mozaic in development or environment mode. For more information on this subject, [see the dedicated document](/GetStarted/Developers/Installation/postcss/#compiling-for-production).
