...
<Story id="foundations-magic-unit--default" height="460" />
...
<br />
<HintItem>
  Use <b>quarter</b> of magic unit for sizes{' '}
...
<HintItem>
  Use magic unit <b>multiplied by integers</b> numbers for sizes{' '}
  <b>greater than 4 magic units</b>
</HintItem>
<br />
...
<HintItem>
  Use for max-height, min-height, max-width, min-width, to determine the
  standards desired sizes
</HintItem>
<HintItem>Use for margin and paddings</HintItem>
<HintItem>
  Use for width and height of determined sized elements (icons, checkboxes, some
  images)
</HintItem>
<HintItem dont>
