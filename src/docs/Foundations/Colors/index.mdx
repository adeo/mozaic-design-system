...
> Mozaic offers an adaptive and scalable color system. The color palette has been divided in four categories: **Primary colors**, **Secondary colors**,**Greys** and **Status colors**.
