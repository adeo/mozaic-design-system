...
> **The magic unit is a base unit for any element or property that requires a defined dimension**. It is equal to **16px** but is expressed in **rem**.<br /> We multiply or divide it to define white spaces, icons sizes, lines heights etc...
...
- It help create a sense of vertical rhythm (or baseline)
- It help create **consistently sized and spaced elements**
...
We can see the red squares snapping to the magic unit grid.
...
The level of granularity that can be used depends on the size of what you are trying to define.
...
<HintItem>
  Use <b>halfs</b> of magic unit for sizes <b>between two and four times the magic unit</b>
</HintItem>
<HintItem>
...
#### Keep in mind that most elements should be designed to be able to grow and stretch with responsiveness and accessibility in mind :
...
- User customized browser zooms and font-sizes may break Its ideal composition.
- New devices form factors that we didn't expect may appear in the future.

All those reasons might end up breaking your one line button into multiples lines on users' screen.

> Building a **resiliant and elegant system** requires a design that fits perfectly for the most common cases but **degrade gracefully** in the most unexpected ones.
