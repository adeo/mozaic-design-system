...
> the **magic-unit function** returns an **unitless** multiplication of the magic unit **expressed in px**, and expect a **multiplier** parameter.
...
**it is particularly usefull when you need to make calculations.**
