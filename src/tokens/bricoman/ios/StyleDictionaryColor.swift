...
public class StyleDictionaryColor {
    ...
    public static let colorInputCheckedHoverBorder = UIColor(red: 0.722, green: 0.247, blue: 0.000, alpha: 1)
    ...
    public static let colorLinkPrimaryActive = UIColor(red: 0.722, green: 0.247, blue: 0.000, alpha: 1)
    public static let colorLinkPrimaryBase = UIColor(red: 0.722, green: 0.247, blue: 0.000, alpha: 1)
    public static let colorLinkPrimaryDisabled = UIColor(red: 0.902, green: 0.902, blue: 0.902, alpha: 1)
    public static let colorLinkPrimaryHover = UIColor(red: 0.580, green: 0.200, blue: 0.000, alpha: 1)
    public static let colorLinkPrimaryVisited = UIColor(red: 0.722, green: 0.247, blue: 0.000, alpha: 1)
